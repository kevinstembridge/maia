...
class CharlieEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: CharlieEntityFilter): CharlieEntityFilter {
    ...
    fun or(vararg filters: CharlieEntityFilter): CharlieEntityFilter {
    ...
    fun nor(vararg filters: CharlieEntityFilter): CharlieEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): CharlieEntityFilter {
        ...
        infix fun gt(value: T): CharlieEntityFilter {
        ...
        infix fun gte(value: T): CharlieEntityFilter {
        ...
        infix fun lt(value: T): CharlieEntityFilter {
        ...
        infix fun lte(value: T): CharlieEntityFilter {
        ...
        infix fun ne(value: T): CharlieEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): CharlieEntityFilter {
        ...
        fun isNotNull(): CharlieEntityFilter {
        ...
        fun isNull(): CharlieEntityFilter {
        ...
        infix fun contains(value: T): CharlieEntityFilter {
    ...
    class NoopFilter : CharlieEntityFilter {


        override fun whereClause(fieldConverter: CharlieEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<CharlieEntityFilter>,
