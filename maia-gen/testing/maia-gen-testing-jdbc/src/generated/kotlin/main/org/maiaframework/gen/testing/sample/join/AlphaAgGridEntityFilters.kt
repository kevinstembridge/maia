...
class AlphaAgGridEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: AlphaAgGridEntityFilter): AlphaAgGridEntityFilter {
    ...
    fun or(vararg filters: AlphaAgGridEntityFilter): AlphaAgGridEntityFilter {
    ...
    fun nor(vararg filters: AlphaAgGridEntityFilter): AlphaAgGridEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): AlphaAgGridEntityFilter {
        ...
        infix fun gt(value: T): AlphaAgGridEntityFilter {
        ...
        infix fun gte(value: T): AlphaAgGridEntityFilter {
        ...
        infix fun lt(value: T): AlphaAgGridEntityFilter {
        ...
        infix fun lte(value: T): AlphaAgGridEntityFilter {
        ...
        infix fun ne(value: T): AlphaAgGridEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): AlphaAgGridEntityFilter {
        ...
        fun isNotNull(): AlphaAgGridEntityFilter {
        ...
        fun isNull(): AlphaAgGridEntityFilter {
        ...
        infix fun contains(value: T): AlphaAgGridEntityFilter {
    ...
    class NoopFilter : AlphaAgGridEntityFilter {


        override fun whereClause(fieldConverter: AlphaAgGridEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<AlphaAgGridEntityFilter>,
