...
class VerySimpleEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: VerySimpleEntityFilter): VerySimpleEntityFilter {
    ...
    fun or(vararg filters: VerySimpleEntityFilter): VerySimpleEntityFilter {
    ...
    fun nor(vararg filters: VerySimpleEntityFilter): VerySimpleEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): VerySimpleEntityFilter {
        ...
        infix fun gt(value: T): VerySimpleEntityFilter {
        ...
        infix fun gte(value: T): VerySimpleEntityFilter {
        ...
        infix fun lt(value: T): VerySimpleEntityFilter {
        ...
        infix fun lte(value: T): VerySimpleEntityFilter {
        ...
        infix fun ne(value: T): VerySimpleEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): VerySimpleEntityFilter {
        ...
        fun isNotNull(): VerySimpleEntityFilter {
        ...
        fun isNull(): VerySimpleEntityFilter {
        ...
        infix fun contains(value: T): VerySimpleEntityFilter {
    ...
    class NoopFilter : VerySimpleEntityFilter {


        override fun whereClause(fieldConverter: VerySimpleEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<VerySimpleEntityFilter>,
