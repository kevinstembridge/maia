...
class CharlieAgGridDtoDao(
    ...
    fun search(searchModel: SearchModel): SearchResultPage<CharlieAgGridDto> {
        ...
        val sqlForTotalCount = """
            ...
            inner join testing.bravo_ag_grid
                    on testing.charlie_ag_grid.bravo_id = testing.bravo_ag_grid.id
        ...
        val sqlForPage = """
            select
                ...
                testing.charlie_ag_grid.some_string as dtoStringFromCharlie
            from testing.charlie_ag_grid
            inner join testing.bravo_ag_grid
                    on testing.charlie_ag_grid.bravo_id = testing.bravo_ag_grid.id
            inner join testing.alpha_ag_grid
