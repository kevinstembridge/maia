...
class PartyHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: PartyHistoryEntityFilter): PartyHistoryEntityFilter {
    ...
    fun or(vararg filters: PartyHistoryEntityFilter): PartyHistoryEntityFilter {
    ...
    fun nor(vararg filters: PartyHistoryEntityFilter): PartyHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): PartyHistoryEntityFilter {
        ...
        infix fun gt(value: T): PartyHistoryEntityFilter {
        ...
        infix fun gte(value: T): PartyHistoryEntityFilter {
        ...
        infix fun lt(value: T): PartyHistoryEntityFilter {
        ...
        infix fun lte(value: T): PartyHistoryEntityFilter {
        ...
        infix fun ne(value: T): PartyHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): PartyHistoryEntityFilter {
        ...
        fun isNotNull(): PartyHistoryEntityFilter {
        ...
        fun isNull(): PartyHistoryEntityFilter {
        ...
        infix fun contains(value: T): PartyHistoryEntityFilter {
    ...
    class NoopFilter : PartyHistoryEntityFilter {


        override fun whereClause(fieldConverter: PartyHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<PartyHistoryEntityFilter>,
