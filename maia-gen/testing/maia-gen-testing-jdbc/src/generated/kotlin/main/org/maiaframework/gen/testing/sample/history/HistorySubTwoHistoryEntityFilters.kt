...
class HistorySubTwoHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: HistorySubTwoHistoryEntityFilter): HistorySubTwoHistoryEntityFilter {
    ...
    fun or(vararg filters: HistorySubTwoHistoryEntityFilter): HistorySubTwoHistoryEntityFilter {
    ...
    fun nor(vararg filters: HistorySubTwoHistoryEntityFilter): HistorySubTwoHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): HistorySubTwoHistoryEntityFilter {
        ...
        infix fun gt(value: T): HistorySubTwoHistoryEntityFilter {
        ...
        infix fun gte(value: T): HistorySubTwoHistoryEntityFilter {
        ...
        infix fun lt(value: T): HistorySubTwoHistoryEntityFilter {
        ...
        infix fun lte(value: T): HistorySubTwoHistoryEntityFilter {
        ...
        infix fun ne(value: T): HistorySubTwoHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): HistorySubTwoHistoryEntityFilter {
        ...
        fun isNotNull(): HistorySubTwoHistoryEntityFilter {
        ...
        fun isNull(): HistorySubTwoHistoryEntityFilter {
        ...
        infix fun contains(value: T): HistorySubTwoHistoryEntityFilter {
    ...
    class NoopFilter : HistorySubTwoHistoryEntityFilter {


        override fun whereClause(fieldConverter: HistorySubTwoHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : HistorySubTwoHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<HistorySubTwoHistoryEntityFilter>,
