...
class OrganizationEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: OrganizationEntityFilter): OrganizationEntityFilter {
    ...
    fun or(vararg filters: OrganizationEntityFilter): OrganizationEntityFilter {
    ...
    fun nor(vararg filters: OrganizationEntityFilter): OrganizationEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): OrganizationEntityFilter {
        ...
        infix fun gt(value: T): OrganizationEntityFilter {
        ...
        infix fun gte(value: T): OrganizationEntityFilter {
        ...
        infix fun lt(value: T): OrganizationEntityFilter {
        ...
        infix fun lte(value: T): OrganizationEntityFilter {
        ...
        infix fun ne(value: T): OrganizationEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): OrganizationEntityFilter {
        ...
        fun isNotNull(): OrganizationEntityFilter {
        ...
        fun isNull(): OrganizationEntityFilter {
        ...
        infix fun contains(value: T): OrganizationEntityFilter {
    ...
    class NoopFilter : OrganizationEntityFilter {


        override fun whereClause(fieldConverter: OrganizationEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<OrganizationEntityFilter>,
