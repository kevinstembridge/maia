...
class HistorySubOneHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: HistorySubOneHistoryEntityFilter): HistorySubOneHistoryEntityFilter {
    ...
    fun or(vararg filters: HistorySubOneHistoryEntityFilter): HistorySubOneHistoryEntityFilter {
    ...
    fun nor(vararg filters: HistorySubOneHistoryEntityFilter): HistorySubOneHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): HistorySubOneHistoryEntityFilter {
        ...
        infix fun gt(value: T): HistorySubOneHistoryEntityFilter {
        ...
        infix fun gte(value: T): HistorySubOneHistoryEntityFilter {
        ...
        infix fun lt(value: T): HistorySubOneHistoryEntityFilter {
        ...
        infix fun lte(value: T): HistorySubOneHistoryEntityFilter {
        ...
        infix fun ne(value: T): HistorySubOneHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): HistorySubOneHistoryEntityFilter {
        ...
        fun isNotNull(): HistorySubOneHistoryEntityFilter {
        ...
        fun isNull(): HistorySubOneHistoryEntityFilter {
        ...
        infix fun contains(value: T): HistorySubOneHistoryEntityFilter {
    ...
    class NoopFilter : HistorySubOneHistoryEntityFilter {


        override fun whereClause(fieldConverter: HistorySubOneHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : HistorySubOneHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<HistorySubOneHistoryEntityFilter>,
