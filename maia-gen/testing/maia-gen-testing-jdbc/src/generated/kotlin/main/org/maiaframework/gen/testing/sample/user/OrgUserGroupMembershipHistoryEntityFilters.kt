...
class OrgUserGroupMembershipHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: OrgUserGroupMembershipHistoryEntityFilter): OrgUserGroupMembershipHistoryEntityFilter {
    ...
    fun or(vararg filters: OrgUserGroupMembershipHistoryEntityFilter): OrgUserGroupMembershipHistoryEntityFilter {
    ...
    fun nor(vararg filters: OrgUserGroupMembershipHistoryEntityFilter): OrgUserGroupMembershipHistoryEntityFilter {
    ...
    val orgUserGroupId: FieldFilter<DomainId> 
        get() {

            return FieldFilter("org_user_group_id", Types.OTHER, this.sqlParamCounter) { value -> value?.value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        infix fun gt(value: T): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        infix fun gte(value: T): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        infix fun lt(value: T): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        infix fun lte(value: T): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        infix fun ne(value: T): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        fun isNotNull(): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        fun isNull(): OrgUserGroupMembershipHistoryEntityFilter {
        ...
        infix fun contains(value: T): OrgUserGroupMembershipHistoryEntityFilter {
    ...
    class NoopFilter : OrgUserGroupMembershipHistoryEntityFilter {


        override fun whereClause(fieldConverter: OrgUserGroupMembershipHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : OrgUserGroupMembershipHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<OrgUserGroupMembershipHistoryEntityFilter>,
