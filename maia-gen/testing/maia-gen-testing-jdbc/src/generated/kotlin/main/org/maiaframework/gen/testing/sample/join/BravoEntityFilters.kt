...
class BravoEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: BravoEntityFilter): BravoEntityFilter {
    ...
    fun or(vararg filters: BravoEntityFilter): BravoEntityFilter {
    ...
    fun nor(vararg filters: BravoEntityFilter): BravoEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): BravoEntityFilter {
        ...
        infix fun gt(value: T): BravoEntityFilter {
        ...
        infix fun gte(value: T): BravoEntityFilter {
        ...
        infix fun lt(value: T): BravoEntityFilter {
        ...
        infix fun lte(value: T): BravoEntityFilter {
        ...
        infix fun ne(value: T): BravoEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): BravoEntityFilter {
        ...
        fun isNotNull(): BravoEntityFilter {
        ...
        infix fun contains(value: T): BravoEntityFilter {
    ...
    class NoopFilter : BravoEntityFilter {


        override fun whereClause(fieldConverter: BravoEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<BravoEntityFilter>,
