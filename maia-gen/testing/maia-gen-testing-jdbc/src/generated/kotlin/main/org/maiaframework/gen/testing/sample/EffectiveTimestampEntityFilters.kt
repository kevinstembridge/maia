...
class EffectiveTimestampEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: EffectiveTimestampEntityFilter): EffectiveTimestampEntityFilter {
    ...
    fun or(vararg filters: EffectiveTimestampEntityFilter): EffectiveTimestampEntityFilter {
    ...
    fun nor(vararg filters: EffectiveTimestampEntityFilter): EffectiveTimestampEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): EffectiveTimestampEntityFilter {
        ...
        infix fun gt(value: T): EffectiveTimestampEntityFilter {
        ...
        infix fun gte(value: T): EffectiveTimestampEntityFilter {
        ...
        infix fun lt(value: T): EffectiveTimestampEntityFilter {
        ...
        infix fun lte(value: T): EffectiveTimestampEntityFilter {
        ...
        infix fun ne(value: T): EffectiveTimestampEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): EffectiveTimestampEntityFilter {
        ...
        fun isNotNull(): EffectiveTimestampEntityFilter {
        ...
        fun isNull(): EffectiveTimestampEntityFilter {
        ...
        infix fun contains(value: T): EffectiveTimestampEntityFilter {
    ...
    class NoopFilter : EffectiveTimestampEntityFilter {
    ...
    ) : EffectiveTimestampEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<EffectiveTimestampEntityFilter>,
