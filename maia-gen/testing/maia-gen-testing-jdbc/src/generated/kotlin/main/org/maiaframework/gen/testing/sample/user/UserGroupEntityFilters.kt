...
class UserGroupEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: UserGroupEntityFilter): UserGroupEntityFilter {
    ...
    fun or(vararg filters: UserGroupEntityFilter): UserGroupEntityFilter {
    ...
    fun nor(vararg filters: UserGroupEntityFilter): UserGroupEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): UserGroupEntityFilter {
        ...
        infix fun gt(value: T): UserGroupEntityFilter {
        ...
        infix fun gte(value: T): UserGroupEntityFilter {
        ...
        infix fun lt(value: T): UserGroupEntityFilter {
        ...
        infix fun lte(value: T): UserGroupEntityFilter {
        ...
        infix fun ne(value: T): UserGroupEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): UserGroupEntityFilter {
        ...
        fun isNotNull(): UserGroupEntityFilter {
        ...
        fun isNull(): UserGroupEntityFilter {
        ...
        infix fun contains(value: T): UserGroupEntityFilter {
    ...
    class NoopFilter : UserGroupEntityFilter {


        override fun whereClause(fieldConverter: UserGroupEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<UserGroupEntityFilter>,
