...
class AlphaEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: AlphaEntityFilter): AlphaEntityFilter {
    ...
    fun or(vararg filters: AlphaEntityFilter): AlphaEntityFilter {
    ...
    fun nor(vararg filters: AlphaEntityFilter): AlphaEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): AlphaEntityFilter {
        ...
        infix fun gt(value: T): AlphaEntityFilter {
        ...
        infix fun gte(value: T): AlphaEntityFilter {
        ...
        infix fun lt(value: T): AlphaEntityFilter {
        ...
        infix fun lte(value: T): AlphaEntityFilter {
        ...
        infix fun ne(value: T): AlphaEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): AlphaEntityFilter {
        ...
        fun isNotNull(): AlphaEntityFilter {
        ...
        infix fun contains(value: T): AlphaEntityFilter {
    ...
    class NoopFilter : AlphaEntityFilter {


        override fun whereClause(fieldConverter: AlphaEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<AlphaEntityFilter>,
