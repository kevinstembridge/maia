...
class SubOneEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: SubOneEntityFilter): SubOneEntityFilter {
    ...
    fun or(vararg filters: SubOneEntityFilter): SubOneEntityFilter {
    ...
    fun nor(vararg filters: SubOneEntityFilter): SubOneEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): SubOneEntityFilter {
        ...
        infix fun gt(value: T): SubOneEntityFilter {
        ...
        infix fun gte(value: T): SubOneEntityFilter {
        ...
        infix fun lt(value: T): SubOneEntityFilter {
        ...
        infix fun lte(value: T): SubOneEntityFilter {
        ...
        infix fun ne(value: T): SubOneEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): SubOneEntityFilter {
        ...
        fun isNotNull(): SubOneEntityFilter {
        ...
        infix fun contains(value: T): SubOneEntityFilter {
    ...
    class NoopFilter : SubOneEntityFilter {


        override fun whereClause(fieldConverter: SubOneEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<SubOneEntityFilter>,
