...
class UserHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: UserHistoryEntityFilter): UserHistoryEntityFilter {
    ...
    fun or(vararg filters: UserHistoryEntityFilter): UserHistoryEntityFilter {
    ...
    fun nor(vararg filters: UserHistoryEntityFilter): UserHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): UserHistoryEntityFilter {
        ...
        infix fun gt(value: T): UserHistoryEntityFilter {
        ...
        infix fun gte(value: T): UserHistoryEntityFilter {
        ...
        infix fun lt(value: T): UserHistoryEntityFilter {
        ...
        infix fun lte(value: T): UserHistoryEntityFilter {
        ...
        infix fun ne(value: T): UserHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): UserHistoryEntityFilter {
        ...
        fun isNotNull(): UserHistoryEntityFilter {
        ...
        fun isNull(): UserHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<UserHistoryEntityFilter>,
