...
class UserGroupHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: UserGroupHistoryEntityFilter): UserGroupHistoryEntityFilter {
    ...
    fun or(vararg filters: UserGroupHistoryEntityFilter): UserGroupHistoryEntityFilter {
    ...
    fun nor(vararg filters: UserGroupHistoryEntityFilter): UserGroupHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): UserGroupHistoryEntityFilter {
        ...
        infix fun gt(value: T): UserGroupHistoryEntityFilter {
        ...
        infix fun gte(value: T): UserGroupHistoryEntityFilter {
        ...
        infix fun lt(value: T): UserGroupHistoryEntityFilter {
        ...
        infix fun lte(value: T): UserGroupHistoryEntityFilter {
        ...
        infix fun ne(value: T): UserGroupHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): UserGroupHistoryEntityFilter {
        ...
        fun isNotNull(): UserGroupHistoryEntityFilter {
        ...
        fun isNull(): UserGroupHistoryEntityFilter {
        ...
        infix fun contains(value: T): UserGroupHistoryEntityFilter {
    ...
    class NoopFilter : UserGroupHistoryEntityFilter {


        override fun whereClause(fieldConverter: UserGroupHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<UserGroupHistoryEntityFilter>,
