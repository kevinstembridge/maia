...
class OrgUserGroupMembershipEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: OrgUserGroupMembershipEntityFilter): OrgUserGroupMembershipEntityFilter {
    ...
    fun or(vararg filters: OrgUserGroupMembershipEntityFilter): OrgUserGroupMembershipEntityFilter {
    ...
    fun nor(vararg filters: OrgUserGroupMembershipEntityFilter): OrgUserGroupMembershipEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): OrgUserGroupMembershipEntityFilter {
        ...
        infix fun gt(value: T): OrgUserGroupMembershipEntityFilter {
        ...
        infix fun gte(value: T): OrgUserGroupMembershipEntityFilter {
        ...
        infix fun lt(value: T): OrgUserGroupMembershipEntityFilter {
        ...
        infix fun lte(value: T): OrgUserGroupMembershipEntityFilter {
        ...
        infix fun ne(value: T): OrgUserGroupMembershipEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): OrgUserGroupMembershipEntityFilter {
        ...
        fun isNotNull(): OrgUserGroupMembershipEntityFilter {
        ...
        fun isNull(): OrgUserGroupMembershipEntityFilter {
        ...
        infix fun contains(value: T): OrgUserGroupMembershipEntityFilter {
    ...
    class NoopFilter : OrgUserGroupMembershipEntityFilter {


        override fun whereClause(fieldConverter: OrgUserGroupMembershipEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : OrgUserGroupMembershipEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<OrgUserGroupMembershipEntityFilter>,
