...
class EntityHistoryBlotterRowDtoTypescriptRendererTest {
    ...
    fun `renders import for a response DTO typed field`(@TempDir tempDir: File) {
        ...
        val historyBlotterDef = spec.widget.historyBlotterDef!!

        EntityHistoryBlotterRowDtoTypescriptRenderer(historyBlotterDef).renderToDir(tempDir)
