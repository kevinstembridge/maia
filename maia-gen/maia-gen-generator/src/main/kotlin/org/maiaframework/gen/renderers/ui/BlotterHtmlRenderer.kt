...
class BlotterHtmlRenderer(private val dtoDef: BlotterDef) : AbstractSourceFileRenderer() {


    override fun renderedFilePath(): String {

        return dtoDef.blotterComponent.htmlRenderedFilePath
    ...
    override fun renderSource(): String {
        ...
        this.dtoDef.blotterColumnDefs.forEach { fieldDef ->
        ...
        if (this.dtoDef.clickableBlotterRowDef == null) {
