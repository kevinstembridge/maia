...
data class ModuleGeneratorFixture_old(
    ...
    companion object {
        ...
        fun from(args: Array<String>): ModuleGeneratorFixture_old {
            ...
            return ModuleGeneratorFixture_old(maiaGenerationContext, modelDefs)
