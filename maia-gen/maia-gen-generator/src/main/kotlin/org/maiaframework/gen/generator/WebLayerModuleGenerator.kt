...
class WebLayerModuleGenerator(
    ...
    private fun renderEntityDetailEndpoint(entityDetailViewDef: EntityDetailViewDef) {

        EntityDetailDtoEndpointRenderer(entityDetailViewDef).renderToDir(this.kotlinOutputDir)
