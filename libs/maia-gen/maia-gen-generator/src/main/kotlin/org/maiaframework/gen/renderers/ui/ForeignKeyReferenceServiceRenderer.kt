...
class ForeignKeyReferenceServiceRenderer(private val entityDefs: Set<EntityDef>) : AbstractTypescriptRenderer() {
    ...
    override fun renderSourceBody() {
        ...
        appendLine("import {${MaiaGenConstants.FOREIGN_KEY_REFERENCES_EXIST_RESPONSE_DTO_CLASS_NAME} } from '@app/models/${MaiaGenConstants.FOREIGN_KEY_REFERENCES_EXIST_RESPONSE_DTO_CLASS_NAME}';")
        blankLine()
        blankLine()
