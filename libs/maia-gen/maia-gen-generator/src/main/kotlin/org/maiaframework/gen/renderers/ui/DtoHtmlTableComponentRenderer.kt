...
class DtoHtmlTableComponentRenderer(private val dtoHtmlTableDef: DtoHtmlTableDef) : AbstractTypescriptRenderer() {
    ...
    override fun renderSourceBody() {
        ...
        appendLine("import { $searchResultUqcn } from '@app/models/$searchResultUqcn';")
        appendLine("import { SearchModel } from '@app/models/SearchModel';")
        appendLine("import { FilterModelItem } from '@app/models/FilterModelItem';")
        appendLine("import { SortModelItem } from '@app/models/SortModelItem';")
