...
class HistorySampleEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: HistorySampleEntityFilter): HistorySampleEntityFilter {
    ...
    fun or(vararg filters: HistorySampleEntityFilter): HistorySampleEntityFilter {
    ...
    fun nor(vararg filters: HistorySampleEntityFilter): HistorySampleEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): HistorySampleEntityFilter {
        ...
        infix fun gt(value: T): HistorySampleEntityFilter {
        ...
        infix fun gte(value: T): HistorySampleEntityFilter {
        ...
        infix fun lt(value: T): HistorySampleEntityFilter {
        ...
        infix fun lte(value: T): HistorySampleEntityFilter {
        ...
        infix fun ne(value: T): HistorySampleEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): HistorySampleEntityFilter {
        ...
        fun isNotNull(): HistorySampleEntityFilter {
        ...
        fun isNull(): HistorySampleEntityFilter {
        ...
        infix fun contains(value: T): HistorySampleEntityFilter {
    ...
    class NoopFilter : HistorySampleEntityFilter {


        override fun whereClause(fieldConverter: HistorySampleEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<HistorySampleEntityFilter>,
