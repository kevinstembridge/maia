...
class BravoAgGridEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: BravoAgGridEntityFilter): BravoAgGridEntityFilter {
    ...
    fun or(vararg filters: BravoAgGridEntityFilter): BravoAgGridEntityFilter {
    ...
    fun nor(vararg filters: BravoAgGridEntityFilter): BravoAgGridEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): BravoAgGridEntityFilter {
        ...
        infix fun gt(value: T): BravoAgGridEntityFilter {
        ...
        infix fun gte(value: T): BravoAgGridEntityFilter {
        ...
        infix fun lt(value: T): BravoAgGridEntityFilter {
        ...
        infix fun lte(value: T): BravoAgGridEntityFilter {
        ...
        infix fun ne(value: T): BravoAgGridEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): BravoAgGridEntityFilter {
        ...
        fun isNotNull(): BravoAgGridEntityFilter {
        ...
        fun isNull(): BravoAgGridEntityFilter {
        ...
        infix fun contains(value: T): BravoAgGridEntityFilter {
    ...
    class NoopFilter : BravoAgGridEntityFilter {


        override fun whereClause(fieldConverter: BravoAgGridEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<BravoAgGridEntityFilter>,
