...
class NonSurrogateIdPrimaryKeyEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: NonSurrogateIdPrimaryKeyEntityFilter): NonSurrogateIdPrimaryKeyEntityFilter {
    ...
    fun or(vararg filters: NonSurrogateIdPrimaryKeyEntityFilter): NonSurrogateIdPrimaryKeyEntityFilter {
    ...
    fun nor(vararg filters: NonSurrogateIdPrimaryKeyEntityFilter): NonSurrogateIdPrimaryKeyEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        infix fun gt(value: T): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        infix fun gte(value: T): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        infix fun lt(value: T): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        infix fun lte(value: T): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        infix fun ne(value: T): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        fun isNotNull(): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        fun isNull(): NonSurrogateIdPrimaryKeyEntityFilter {
        ...
        infix fun contains(value: T): NonSurrogateIdPrimaryKeyEntityFilter {
    ...
    class NoopFilter : NonSurrogateIdPrimaryKeyEntityFilter {


        override fun whereClause(fieldConverter: NonSurrogateIdPrimaryKeyEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : NonSurrogateIdPrimaryKeyEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<NonSurrogateIdPrimaryKeyEntityFilter>,
