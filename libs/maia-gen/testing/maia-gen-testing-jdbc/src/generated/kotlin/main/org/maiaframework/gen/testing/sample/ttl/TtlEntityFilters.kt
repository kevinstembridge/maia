...
class TtlEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: TtlEntityFilter): TtlEntityFilter {
    ...
    fun or(vararg filters: TtlEntityFilter): TtlEntityFilter {
    ...
    fun nor(vararg filters: TtlEntityFilter): TtlEntityFilter {
    ...
    val createdAt: FieldFilter<Instant> 
        get() {

            return FieldFilter("created_at", Types.TIMESTAMP, this.sqlParamCounter) { value -> value?.let { Timestamp.from(it) } }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): TtlEntityFilter {
        ...
        infix fun gt(value: T): TtlEntityFilter {
        ...
        infix fun gte(value: T): TtlEntityFilter {
        ...
        infix fun lt(value: T): TtlEntityFilter {
        ...
        infix fun lte(value: T): TtlEntityFilter {
        ...
        infix fun ne(value: T): TtlEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): TtlEntityFilter {
        ...
        infix fun contains(value: T): TtlEntityFilter {
    ...
    class NoopFilter : TtlEntityFilter {


        override fun whereClause(fieldConverter: TtlEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<TtlEntityFilter>,
