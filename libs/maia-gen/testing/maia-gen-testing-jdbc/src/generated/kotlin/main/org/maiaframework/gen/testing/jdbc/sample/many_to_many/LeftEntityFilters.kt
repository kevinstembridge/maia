...
class LeftEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftEntityFilter): LeftEntityFilter {
    ...
    fun or(vararg filters: LeftEntityFilter): LeftEntityFilter {
    ...
    fun nor(vararg filters: LeftEntityFilter): LeftEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftEntityFilter {
        ...
        infix fun gt(value: T): LeftEntityFilter {
        ...
        infix fun gte(value: T): LeftEntityFilter {
        ...
        infix fun lt(value: T): LeftEntityFilter {
        ...
        infix fun lte(value: T): LeftEntityFilter {
        ...
        infix fun ne(value: T): LeftEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftEntityFilter {
        ...
        fun isNotNull(): LeftEntityFilter {
        ...
        infix fun contains(value: T): LeftEntityFilter {
    ...
    class NoopFilter : LeftEntityFilter {


        override fun whereClause(fieldConverter: LeftEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftEntityFilter>,
