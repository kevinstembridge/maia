...
object NonSurrogateIdPrimaryKeyHistoryEntityMeta {
    ...
    val ENTITY_KEY = EntityKey("NonSurrogateIdPrimaryKeyHistory")

    val TYPE_DISCRIMINATORS = sortedSetOf<TypeDiscriminator>()

    val SCHEMA_NAME = SchemaName("testing")

    val TABLE_NAME = TableName("non_surrogate_id_primary_key_history")
