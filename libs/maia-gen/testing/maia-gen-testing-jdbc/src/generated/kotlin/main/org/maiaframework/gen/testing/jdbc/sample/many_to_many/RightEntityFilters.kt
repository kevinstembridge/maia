...
class RightEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: RightEntityFilter): RightEntityFilter {
    ...
    fun or(vararg filters: RightEntityFilter): RightEntityFilter {
    ...
    fun nor(vararg filters: RightEntityFilter): RightEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): RightEntityFilter {
        ...
        infix fun gt(value: T): RightEntityFilter {
        ...
        infix fun gte(value: T): RightEntityFilter {
        ...
        infix fun lt(value: T): RightEntityFilter {
        ...
        infix fun lte(value: T): RightEntityFilter {
        ...
        infix fun ne(value: T): RightEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): RightEntityFilter {
        ...
        fun isNotNull(): RightEntityFilter {
        ...
        infix fun contains(value: T): RightEntityFilter {
    ...
    class NoopFilter : RightEntityFilter {


        override fun whereClause(fieldConverter: RightEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<RightEntityFilter>,
