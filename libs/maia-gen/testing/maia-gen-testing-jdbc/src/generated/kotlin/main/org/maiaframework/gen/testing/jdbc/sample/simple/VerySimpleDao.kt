...
class VerySimpleDao(
    ...
    fun findByPrimaryKey(id: DomainId): VerySimpleEntity {
        ...
        return findByPrimaryKeyOrNull(id)
            ?: throw EntityNotFoundException(
                EntityClassAndPk(
                    VerySimpleEntity::class.java,
                    mapOf(
                        "id" to id,
                    )
                ),
                VerySimpleEntityMeta.TABLE_NAME
            )
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from testing.very_simple where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findPrimaryKeysAsSequence(filter: VerySimpleEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from testing.very_simple where $whereClause",
            sqlParams,
