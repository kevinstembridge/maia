...
class SuperEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: SuperEntityFilter): SuperEntityFilter {
    ...
    fun or(vararg filters: SuperEntityFilter): SuperEntityFilter {
    ...
    fun nor(vararg filters: SuperEntityFilter): SuperEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): SuperEntityFilter {
        ...
        infix fun gt(value: T): SuperEntityFilter {
        ...
        infix fun gte(value: T): SuperEntityFilter {
        ...
        infix fun lt(value: T): SuperEntityFilter {
        ...
        infix fun lte(value: T): SuperEntityFilter {
        ...
        infix fun ne(value: T): SuperEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): SuperEntityFilter {
        ...
        fun isNotNull(): SuperEntityFilter {
        ...
        infix fun contains(value: T): SuperEntityFilter {
    ...
    class NoopFilter : SuperEntityFilter {


        override fun whereClause(fieldConverter: SuperEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<SuperEntityFilter>,
