...
class SimpleEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: SimpleEntityFilter): SimpleEntityFilter {
    ...
    fun or(vararg filters: SimpleEntityFilter): SimpleEntityFilter {
    ...
    fun nor(vararg filters: SimpleEntityFilter): SimpleEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): SimpleEntityFilter {
        ...
        infix fun gt(value: T): SimpleEntityFilter {
        ...
        infix fun gte(value: T): SimpleEntityFilter {
        ...
        infix fun lt(value: T): SimpleEntityFilter {
        ...
        infix fun lte(value: T): SimpleEntityFilter {
        ...
        infix fun ne(value: T): SimpleEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): SimpleEntityFilter {
        ...
        fun isNotNull(): SimpleEntityFilter {
        ...
        infix fun contains(value: T): SimpleEntityFilter {
    ...
    class NoopFilter : SimpleEntityFilter {


        override fun whereClause(fieldConverter: SimpleEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<SimpleEntityFilter>,
