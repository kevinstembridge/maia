...
class SomeVersionedEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: SomeVersionedEntityFilter): SomeVersionedEntityFilter {
    ...
    fun or(vararg filters: SomeVersionedEntityFilter): SomeVersionedEntityFilter {
    ...
    fun nor(vararg filters: SomeVersionedEntityFilter): SomeVersionedEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): SomeVersionedEntityFilter {
        ...
        infix fun gt(value: T): SomeVersionedEntityFilter {
        ...
        infix fun gte(value: T): SomeVersionedEntityFilter {
        ...
        infix fun lt(value: T): SomeVersionedEntityFilter {
        ...
        infix fun lte(value: T): SomeVersionedEntityFilter {
        ...
        infix fun ne(value: T): SomeVersionedEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): SomeVersionedEntityFilter {
        ...
        fun isNotNull(): SomeVersionedEntityFilter {
        ...
        fun isNull(): SomeVersionedEntityFilter {
        ...
        infix fun contains(value: T): SomeVersionedEntityFilter {
    ...
    class NoopFilter : SomeVersionedEntityFilter {


        override fun whereClause(fieldConverter: SomeVersionedEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<SomeVersionedEntityFilter>,
