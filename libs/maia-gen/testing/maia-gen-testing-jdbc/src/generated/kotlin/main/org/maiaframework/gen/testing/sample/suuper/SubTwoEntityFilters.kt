...
class SubTwoEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: SubTwoEntityFilter): SubTwoEntityFilter {
    ...
    fun or(vararg filters: SubTwoEntityFilter): SubTwoEntityFilter {
    ...
    fun nor(vararg filters: SubTwoEntityFilter): SubTwoEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): SubTwoEntityFilter {
        ...
        infix fun gt(value: T): SubTwoEntityFilter {
        ...
        infix fun gte(value: T): SubTwoEntityFilter {
        ...
        infix fun lt(value: T): SubTwoEntityFilter {
        ...
        infix fun lte(value: T): SubTwoEntityFilter {
        ...
        infix fun ne(value: T): SubTwoEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): SubTwoEntityFilter {
        ...
        fun isNotNull(): SubTwoEntityFilter {
        ...
        infix fun contains(value: T): SubTwoEntityFilter {
    ...
    class NoopFilter : SubTwoEntityFilter {


        override fun whereClause(fieldConverter: SubTwoEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<SubTwoEntityFilter>,
