...
class CharlieAgGridEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: CharlieAgGridEntityFilter): CharlieAgGridEntityFilter {
    ...
    fun or(vararg filters: CharlieAgGridEntityFilter): CharlieAgGridEntityFilter {
    ...
    fun nor(vararg filters: CharlieAgGridEntityFilter): CharlieAgGridEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): CharlieAgGridEntityFilter {
        ...
        infix fun gt(value: T): CharlieAgGridEntityFilter {
        ...
        infix fun gte(value: T): CharlieAgGridEntityFilter {
        ...
        infix fun lt(value: T): CharlieAgGridEntityFilter {
        ...
        infix fun lte(value: T): CharlieAgGridEntityFilter {
        ...
        infix fun ne(value: T): CharlieAgGridEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): CharlieAgGridEntityFilter {
        ...
        fun isNotNull(): CharlieAgGridEntityFilter {
        ...
        fun isNull(): CharlieAgGridEntityFilter {
        ...
        infix fun contains(value: T): CharlieAgGridEntityFilter {
    ...
    class NoopFilter : CharlieAgGridEntityFilter {


        override fun whereClause(fieldConverter: CharlieAgGridEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<CharlieAgGridEntityFilter>,
