...
class OrgUserGroupHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: OrgUserGroupHistoryEntityFilter): OrgUserGroupHistoryEntityFilter {
    ...
    fun or(vararg filters: OrgUserGroupHistoryEntityFilter): OrgUserGroupHistoryEntityFilter {
    ...
    fun nor(vararg filters: OrgUserGroupHistoryEntityFilter): OrgUserGroupHistoryEntityFilter {
    ...
    val name: FieldFilter<String> 
        get() {

            return FieldFilter("name", Types.VARCHAR, this.sqlParamCounter) { value -> value }
    ...
    val systemManaged: FieldFilter<Boolean> 
        get() {
            ...
            return FieldFilter("system_managed", Types.BIT, this.sqlParamCounter) { value -> value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): OrgUserGroupHistoryEntityFilter {
        ...
        infix fun gt(value: T): OrgUserGroupHistoryEntityFilter {
        ...
        infix fun gte(value: T): OrgUserGroupHistoryEntityFilter {
        ...
        infix fun lt(value: T): OrgUserGroupHistoryEntityFilter {
        ...
        infix fun lte(value: T): OrgUserGroupHistoryEntityFilter {
        ...
        infix fun ne(value: T): OrgUserGroupHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): OrgUserGroupHistoryEntityFilter {
        ...
        fun isNotNull(): OrgUserGroupHistoryEntityFilter {
        ...
        fun isNull(): OrgUserGroupHistoryEntityFilter {
        ...
        infix fun contains(value: T): OrgUserGroupHistoryEntityFilter {
    ...
    class NoopFilter : OrgUserGroupHistoryEntityFilter {


        override fun whereClause(fieldConverter: OrgUserGroupHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : OrgUserGroupHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<OrgUserGroupHistoryEntityFilter>,
