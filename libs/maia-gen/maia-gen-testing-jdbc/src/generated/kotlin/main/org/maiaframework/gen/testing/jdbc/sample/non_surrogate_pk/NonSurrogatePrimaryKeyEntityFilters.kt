...
class NonSurrogatePrimaryKeyEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: NonSurrogatePrimaryKeyEntityFilter): NonSurrogatePrimaryKeyEntityFilter {
    ...
    fun or(vararg filters: NonSurrogatePrimaryKeyEntityFilter): NonSurrogatePrimaryKeyEntityFilter {
    ...
    fun nor(vararg filters: NonSurrogatePrimaryKeyEntityFilter): NonSurrogatePrimaryKeyEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): NonSurrogatePrimaryKeyEntityFilter {
        ...
        infix fun gt(value: T): NonSurrogatePrimaryKeyEntityFilter {
        ...
        infix fun gte(value: T): NonSurrogatePrimaryKeyEntityFilter {
        ...
        infix fun lt(value: T): NonSurrogatePrimaryKeyEntityFilter {
        ...
        infix fun lte(value: T): NonSurrogatePrimaryKeyEntityFilter {
        ...
        infix fun ne(value: T): NonSurrogatePrimaryKeyEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): NonSurrogatePrimaryKeyEntityFilter {
        ...
        fun isNotNull(): NonSurrogatePrimaryKeyEntityFilter {
        ...
        fun isNull(): NonSurrogatePrimaryKeyEntityFilter {
        ...
        infix fun contains(value: T): NonSurrogatePrimaryKeyEntityFilter {
    ...
    class NoopFilter : NonSurrogatePrimaryKeyEntityFilter {


        override fun whereClause(fieldConverter: NonSurrogatePrimaryKeyEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : NonSurrogatePrimaryKeyEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<NonSurrogatePrimaryKeyEntityFilter>,
