...
class HistorySuperHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: HistorySuperHistoryEntityFilter): HistorySuperHistoryEntityFilter {
    ...
    fun or(vararg filters: HistorySuperHistoryEntityFilter): HistorySuperHistoryEntityFilter {
    ...
    fun nor(vararg filters: HistorySuperHistoryEntityFilter): HistorySuperHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): HistorySuperHistoryEntityFilter {
        ...
        infix fun gt(value: T): HistorySuperHistoryEntityFilter {
        ...
        infix fun gte(value: T): HistorySuperHistoryEntityFilter {
        ...
        infix fun lt(value: T): HistorySuperHistoryEntityFilter {
        ...
        infix fun lte(value: T): HistorySuperHistoryEntityFilter {
        ...
        infix fun ne(value: T): HistorySuperHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): HistorySuperHistoryEntityFilter {
        ...
        fun isNotNull(): HistorySuperHistoryEntityFilter {
        ...
        fun isNull(): HistorySuperHistoryEntityFilter {
        ...
        infix fun contains(value: T): HistorySuperHistoryEntityFilter {
    ...
    class NoopFilter : HistorySuperHistoryEntityFilter {


        override fun whereClause(fieldConverter: HistorySuperHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : HistorySuperHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<HistorySuperHistoryEntityFilter>,
