...
class HistorySuperEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: HistorySuperEntityFilter): HistorySuperEntityFilter {
    ...
    fun or(vararg filters: HistorySuperEntityFilter): HistorySuperEntityFilter {
    ...
    fun nor(vararg filters: HistorySuperEntityFilter): HistorySuperEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): HistorySuperEntityFilter {
        ...
        infix fun gt(value: T): HistorySuperEntityFilter {
        ...
        infix fun gte(value: T): HistorySuperEntityFilter {
        ...
        infix fun lt(value: T): HistorySuperEntityFilter {
        ...
        infix fun lte(value: T): HistorySuperEntityFilter {
        ...
        infix fun ne(value: T): HistorySuperEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): HistorySuperEntityFilter {
        ...
        fun isNotNull(): HistorySuperEntityFilter {
        ...
        fun isNull(): HistorySuperEntityFilter {
        ...
        infix fun contains(value: T): HistorySuperEntityFilter {
    ...
    class NoopFilter : HistorySuperEntityFilter {


        override fun whereClause(fieldConverter: HistorySuperEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<HistorySuperEntityFilter>,
