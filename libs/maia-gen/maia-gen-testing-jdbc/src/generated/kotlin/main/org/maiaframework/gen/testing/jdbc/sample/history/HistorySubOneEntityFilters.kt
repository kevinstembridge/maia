...
class HistorySubOneEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: HistorySubOneEntityFilter): HistorySubOneEntityFilter {
    ...
    fun or(vararg filters: HistorySubOneEntityFilter): HistorySubOneEntityFilter {
    ...
    fun nor(vararg filters: HistorySubOneEntityFilter): HistorySubOneEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): HistorySubOneEntityFilter {
        ...
        infix fun gt(value: T): HistorySubOneEntityFilter {
        ...
        infix fun gte(value: T): HistorySubOneEntityFilter {
        ...
        infix fun lt(value: T): HistorySubOneEntityFilter {
        ...
        infix fun lte(value: T): HistorySubOneEntityFilter {
        ...
        infix fun ne(value: T): HistorySubOneEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): HistorySubOneEntityFilter {
        ...
        fun isNotNull(): HistorySubOneEntityFilter {
        ...
        fun isNull(): HistorySubOneEntityFilter {
        ...
        infix fun contains(value: T): HistorySubOneEntityFilter {
    ...
    class NoopFilter : HistorySubOneEntityFilter {


        override fun whereClause(fieldConverter: HistorySubOneEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<HistorySubOneEntityFilter>,
