...
class NonSurrogateIdPrimaryKeyDao(
    ...
    fun insert(entity: NonSurrogateIdPrimaryKeyEntity) {
        ...
        jdbcOps.update(
            """
            insert into testing.non_surrogate_id_primary_key (
    ...
    fun count(): Long {
        ...
        return jdbcOps.queryForLong(
            "select count(*) from testing.non_surrogate_id_primary_key",
            SqlParams()
        )
    ...
    fun findByPrimaryKeyOrNull(id: SomeStringValueClass): NonSurrogateIdPrimaryKeyEntity? {
        ...
        return jdbcOps.queryForList(
            "select * from testing.non_surrogate_id_primary_key where id = :id",
            SqlParams().apply {
    ...
    fun existsByPrimaryKey(id: SomeStringValueClass): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from testing.non_surrogate_id_primary_key where id = :id",
            SqlParams().apply {
                addValue("id", id.value)
           }
        )
    ...
    fun findAllBy(filter: NonSurrogateIdPrimaryKeyEntityFilter): List<NonSurrogateIdPrimaryKeyEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from testing.non_surrogate_id_primary_key where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: NonSurrogateIdPrimaryKeyEntityFilter): Sequence<SomeStringValueClass> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from testing.non_surrogate_id_primary_key where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<SomeStringValueClass> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from testing.non_surrogate_id_primary_key;",
            SqlParams(),
            this.primaryKeyRowMapper
        )
    ...
    fun findAllBy(filter: NonSurrogateIdPrimaryKeyEntityFilter, pageable: Pageable): List<NonSurrogateIdPrimaryKeyEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from testing.non_surrogate_id_primary_key where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findAllAsSequence(): Sequence<NonSurrogateIdPrimaryKeyEntity> {
        ...
        return this.jdbcOps.queryForSequence(
            "select * from testing.non_surrogate_id_primary_key;",
            SqlParams(),
            this.entityRowMapper,
        )
    ...
    fun upsertById(upsertEntity: NonSurrogateIdPrimaryKeyEntity): NonSurrogateIdPrimaryKeyEntity {
        ...
        val persistedEntity = jdbcOps.execute(
            ...
            do update set
                ...
                version = testing.non_surrogate_id_primary_key.version + 1
            returning *;
            """.trimIndent(),
            SqlParams().apply {
    ...
    fun setFields(updater: NonSurrogateIdPrimaryKeyEntityUpdater): Int {
        ...
        sql.append("update testing.non_surrogate_id_primary_key set ")
    ...
    fun deleteByPrimaryKey(id: SomeStringValueClass): Boolean {
        ...
        val deletedCount = this.jdbcOps.update(
            "delete from testing.non_surrogate_id_primary_key where id = :id",
            SqlParams().apply {
                addValue("id", id.value)
            }
        )
    ...
    fun deleteAll() {
        this.jdbcOps.update("delete from testing.non_surrogate_id_primary_key")
    }
