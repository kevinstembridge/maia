...
class HistorySampleHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: HistorySampleHistoryEntityFilter): HistorySampleHistoryEntityFilter {
    ...
    fun or(vararg filters: HistorySampleHistoryEntityFilter): HistorySampleHistoryEntityFilter {
    ...
    fun nor(vararg filters: HistorySampleHistoryEntityFilter): HistorySampleHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): HistorySampleHistoryEntityFilter {
        ...
        infix fun gt(value: T): HistorySampleHistoryEntityFilter {
        ...
        infix fun gte(value: T): HistorySampleHistoryEntityFilter {
        ...
        infix fun lt(value: T): HistorySampleHistoryEntityFilter {
        ...
        infix fun lte(value: T): HistorySampleHistoryEntityFilter {
        ...
        infix fun ne(value: T): HistorySampleHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): HistorySampleHistoryEntityFilter {
        ...
        fun isNotNull(): HistorySampleHistoryEntityFilter {
        ...
        fun isNull(): HistorySampleHistoryEntityFilter {
        ...
        infix fun contains(value: T): HistorySampleHistoryEntityFilter {
    ...
    class NoopFilter : HistorySampleHistoryEntityFilter {


        override fun whereClause(fieldConverter: HistorySampleHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : HistorySampleHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<HistorySampleHistoryEntityFilter>,
