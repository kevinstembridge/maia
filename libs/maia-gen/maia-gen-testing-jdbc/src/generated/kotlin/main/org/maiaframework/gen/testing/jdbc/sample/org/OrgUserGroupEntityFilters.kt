...
class OrgUserGroupEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: OrgUserGroupEntityFilter): OrgUserGroupEntityFilter {
    ...
    fun or(vararg filters: OrgUserGroupEntityFilter): OrgUserGroupEntityFilter {
    ...
    fun nor(vararg filters: OrgUserGroupEntityFilter): OrgUserGroupEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): OrgUserGroupEntityFilter {
        ...
        infix fun gt(value: T): OrgUserGroupEntityFilter {
        ...
        infix fun gte(value: T): OrgUserGroupEntityFilter {
        ...
        infix fun lt(value: T): OrgUserGroupEntityFilter {
        ...
        infix fun lte(value: T): OrgUserGroupEntityFilter {
        ...
        infix fun ne(value: T): OrgUserGroupEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): OrgUserGroupEntityFilter {
        ...
        fun isNotNull(): OrgUserGroupEntityFilter {
        ...
        fun isNull(): OrgUserGroupEntityFilter {
        ...
        infix fun contains(value: T): OrgUserGroupEntityFilter {
    ...
    class NoopFilter : OrgUserGroupEntityFilter {


        override fun whereClause(fieldConverter: OrgUserGroupEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<OrgUserGroupEntityFilter>,
