...
class NonSurrogateIdPrimaryKeyHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: NonSurrogateIdPrimaryKeyHistoryEntityFilter): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
    ...
    fun or(vararg filters: NonSurrogateIdPrimaryKeyHistoryEntityFilter): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
    ...
    fun nor(vararg filters: NonSurrogateIdPrimaryKeyHistoryEntityFilter): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
    ...
    val id: FieldFilter<SomeStringValueClass> 
        get() {

            return FieldFilter("id", Types.VARCHAR, this.sqlParamCounter) { value -> value?.value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        infix fun gt(value: T): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        infix fun gte(value: T): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        infix fun lt(value: T): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        infix fun lte(value: T): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        infix fun ne(value: T): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        fun isNotNull(): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        fun isNull(): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
        ...
        infix fun contains(value: T): NonSurrogateIdPrimaryKeyHistoryEntityFilter {
    ...
    class NoopFilter : NonSurrogateIdPrimaryKeyHistoryEntityFilter {


        override fun whereClause(fieldConverter: NonSurrogateIdPrimaryKeyHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : NonSurrogateIdPrimaryKeyHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<NonSurrogateIdPrimaryKeyHistoryEntityFilter>,
