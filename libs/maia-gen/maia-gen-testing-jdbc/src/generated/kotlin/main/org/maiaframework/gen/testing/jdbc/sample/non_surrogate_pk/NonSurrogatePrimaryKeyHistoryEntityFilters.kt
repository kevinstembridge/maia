...
class NonSurrogatePrimaryKeyHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: NonSurrogatePrimaryKeyHistoryEntityFilter): NonSurrogatePrimaryKeyHistoryEntityFilter {
    ...
    fun or(vararg filters: NonSurrogatePrimaryKeyHistoryEntityFilter): NonSurrogatePrimaryKeyHistoryEntityFilter {
    ...
    fun nor(vararg filters: NonSurrogatePrimaryKeyHistoryEntityFilter): NonSurrogatePrimaryKeyHistoryEntityFilter {
    ...
    val someString: FieldFilter<SomeStringValueClass> 
        get() {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        infix fun gt(value: T): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        infix fun gte(value: T): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        infix fun lt(value: T): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        infix fun lte(value: T): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        infix fun ne(value: T): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        fun isNotNull(): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        fun isNull(): NonSurrogatePrimaryKeyHistoryEntityFilter {
        ...
        infix fun contains(value: T): NonSurrogatePrimaryKeyHistoryEntityFilter {
    ...
    class NoopFilter : NonSurrogatePrimaryKeyHistoryEntityFilter {


        override fun whereClause(fieldConverter: NonSurrogatePrimaryKeyHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : NonSurrogatePrimaryKeyHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<NonSurrogatePrimaryKeyHistoryEntityFilter>,
