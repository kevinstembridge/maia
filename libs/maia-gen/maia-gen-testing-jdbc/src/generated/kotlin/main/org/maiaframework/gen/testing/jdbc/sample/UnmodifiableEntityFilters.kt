...
class UnmodifiableEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: UnmodifiableEntityFilter): UnmodifiableEntityFilter {
    ...
    fun or(vararg filters: UnmodifiableEntityFilter): UnmodifiableEntityFilter {
    ...
    fun nor(vararg filters: UnmodifiableEntityFilter): UnmodifiableEntityFilter {
    ...
    val someUniqueInt: FieldFilter<Int> 
        get() {

            return FieldFilter("some_unique_int", Types.INTEGER, this.sqlParamCounter) { value -> value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): UnmodifiableEntityFilter {
        ...
        infix fun gt(value: T): UnmodifiableEntityFilter {
        ...
        infix fun gte(value: T): UnmodifiableEntityFilter {
        ...
        infix fun lt(value: T): UnmodifiableEntityFilter {
        ...
        infix fun lte(value: T): UnmodifiableEntityFilter {
        ...
        infix fun ne(value: T): UnmodifiableEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): UnmodifiableEntityFilter {
        ...
        fun isNotNull(): UnmodifiableEntityFilter {
        ...
        fun isNull(): UnmodifiableEntityFilter {
        ...
        infix fun contains(value: T): UnmodifiableEntityFilter {
    ...
    class NoopFilter : UnmodifiableEntityFilter {


        override fun whereClause(fieldConverter: UnmodifiableEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<UnmodifiableEntityFilter>,
