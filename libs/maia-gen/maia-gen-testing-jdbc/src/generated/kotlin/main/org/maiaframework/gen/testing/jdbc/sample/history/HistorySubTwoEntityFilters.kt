...
class HistorySubTwoEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: HistorySubTwoEntityFilter): HistorySubTwoEntityFilter {
    ...
    fun or(vararg filters: HistorySubTwoEntityFilter): HistorySubTwoEntityFilter {
    ...
    fun nor(vararg filters: HistorySubTwoEntityFilter): HistorySubTwoEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): HistorySubTwoEntityFilter {
        ...
        infix fun gt(value: T): HistorySubTwoEntityFilter {
        ...
        infix fun gte(value: T): HistorySubTwoEntityFilter {
        ...
        infix fun lt(value: T): HistorySubTwoEntityFilter {
        ...
        infix fun lte(value: T): HistorySubTwoEntityFilter {
        ...
        infix fun ne(value: T): HistorySubTwoEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): HistorySubTwoEntityFilter {
        ...
        fun isNotNull(): HistorySubTwoEntityFilter {
        ...
        fun isNull(): HistorySubTwoEntityFilter {
        ...
        infix fun contains(value: T): HistorySubTwoEntityFilter {
    ...
    class NoopFilter : HistorySubTwoEntityFilter {


        override fun whereClause(fieldConverter: HistorySubTwoEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<HistorySubTwoEntityFilter>,
