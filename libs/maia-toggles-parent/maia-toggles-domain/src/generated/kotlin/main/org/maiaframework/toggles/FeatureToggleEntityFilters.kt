...
class FeatureToggleEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: FeatureToggleEntityFilter): FeatureToggleEntityFilter {
    ...
    fun or(vararg filters: FeatureToggleEntityFilter): FeatureToggleEntityFilter {
    ...
    fun nor(vararg filters: FeatureToggleEntityFilter): FeatureToggleEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): FeatureToggleEntityFilter {
        ...
        infix fun gt(value: T): FeatureToggleEntityFilter {
        ...
        infix fun gte(value: T): FeatureToggleEntityFilter {
        ...
        infix fun lt(value: T): FeatureToggleEntityFilter {
        ...
        infix fun lte(value: T): FeatureToggleEntityFilter {
        ...
        infix fun ne(value: T): FeatureToggleEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): FeatureToggleEntityFilter {
        ...
        fun isNotNull(): FeatureToggleEntityFilter {
        ...
        fun isNull(): FeatureToggleEntityFilter {
        ...
        infix fun contains(value: T): FeatureToggleEntityFilter {
    ...
    class NoopFilter : FeatureToggleEntityFilter {


        override fun whereClause(fieldConverter: FeatureToggleEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<FeatureToggleEntityFilter>,
