...
@RestController
class FeatureToggleHistoryBlotterSearchEndpoint(
    private val searchService: FeatureToggleHistoryBlotterRowDtoSearchService
) {
    ...
    ): SearchResultPage<FeatureToggleHistoryBlotterRowDto> {
