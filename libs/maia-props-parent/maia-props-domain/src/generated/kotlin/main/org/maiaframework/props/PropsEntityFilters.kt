...
class PropsEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: PropsEntityFilter): PropsEntityFilter {
    ...
    fun or(vararg filters: PropsEntityFilter): PropsEntityFilter {
    ...
    fun nor(vararg filters: PropsEntityFilter): PropsEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): PropsEntityFilter {
        ...
        infix fun gt(value: T): PropsEntityFilter {
        ...
        infix fun gte(value: T): PropsEntityFilter {
        ...
        infix fun lt(value: T): PropsEntityFilter {
        ...
        infix fun lte(value: T): PropsEntityFilter {
        ...
        infix fun ne(value: T): PropsEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): PropsEntityFilter {
        ...
        fun isNotNull(): PropsEntityFilter {
        ...
        infix fun contains(value: T): PropsEntityFilter {
    ...
    class NoopFilter : PropsEntityFilter {


        override fun whereClause(fieldConverter: PropsEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<PropsEntityFilter>,
