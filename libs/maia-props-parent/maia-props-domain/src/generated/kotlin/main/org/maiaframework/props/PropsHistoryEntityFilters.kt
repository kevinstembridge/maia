...
class PropsHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: PropsHistoryEntityFilter): PropsHistoryEntityFilter {
    ...
    fun or(vararg filters: PropsHistoryEntityFilter): PropsHistoryEntityFilter {
    ...
    fun nor(vararg filters: PropsHistoryEntityFilter): PropsHistoryEntityFilter {
    ...
    val propertyName: FieldFilter<String> 
        get() {

            return FieldFilter("property_name", Types.VARCHAR, this.sqlParamCounter) { value -> value }

        }


    val propertyValue: FieldFilter<String> 
        get() {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): PropsHistoryEntityFilter {
        ...
        infix fun gt(value: T): PropsHistoryEntityFilter {
        ...
        infix fun gte(value: T): PropsHistoryEntityFilter {
        ...
        infix fun lt(value: T): PropsHistoryEntityFilter {
        ...
        infix fun lte(value: T): PropsHistoryEntityFilter {
        ...
        infix fun ne(value: T): PropsHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): PropsHistoryEntityFilter {
        ...
        fun isNotNull(): PropsHistoryEntityFilter {
        ...
        fun isNull(): PropsHistoryEntityFilter {
        ...
        infix fun contains(value: T): PropsHistoryEntityFilter {
    ...
    class NoopFilter : PropsHistoryEntityFilter {


        override fun whereClause(fieldConverter: PropsHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<PropsHistoryEntityFilter>,
