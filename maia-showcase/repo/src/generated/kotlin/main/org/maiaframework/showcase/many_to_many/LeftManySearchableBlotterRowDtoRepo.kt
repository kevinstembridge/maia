...
@Repository
class LeftManySearchableBlotterRowDtoRepo(
    private val dao: LeftManySearchableBlotterRowDtoDao
) {


    fun getRows(searchModel: AgGridSearchModel): SearchResultPage<LeftManySearchableBlotterRowDto> {
