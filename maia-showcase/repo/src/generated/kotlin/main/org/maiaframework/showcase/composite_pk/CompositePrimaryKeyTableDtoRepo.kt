...
@Repository
class CompositePrimaryKeyTableDtoRepo(
    private val dao: CompositePrimaryKeyTableDtoDao
) {


    fun getRows(searchModel: AgGridSearchModel): SearchResultPage<CompositePrimaryKeyTableDto> {
