...
// Renderer class: class org.maiaframework.gen.renderers.SearchableDtoRepoRenderer
...
@Repository
class LeftToRightManyToManyDtoRepo(
    private val dao: LeftToRightManyToManyDtoDao
) {


    fun getRows(searchModel: AgGridSearchModel): SearchResultPage<LeftToRightManyToManyDto> {
