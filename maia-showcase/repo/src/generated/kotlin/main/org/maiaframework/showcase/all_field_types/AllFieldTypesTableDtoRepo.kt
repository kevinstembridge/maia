...
@Repository
class AllFieldTypesTableDtoRepo(
    private val dao: AllFieldTypesTableDtoDao
) {


    fun getRows(searchModel: AgGridSearchModel): SearchResultPage<AllFieldTypesTableDto> {
