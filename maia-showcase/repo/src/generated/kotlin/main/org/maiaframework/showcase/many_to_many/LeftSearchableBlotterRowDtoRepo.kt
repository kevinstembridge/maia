...
@Repository
class LeftSearchableBlotterRowDtoRepo(
    private val dao: LeftSearchableBlotterRowDtoDao
) {


    fun getRows(searchModel: AgGridSearchModel): SearchResultPage<LeftSearchableBlotterRowDto> {
