...
@Repository
class LeftSearchableTableDtoRepo(
    private val dao: LeftSearchableTableDtoDao
) {


    fun getRows(searchModel: AgGridSearchModel): SearchResultPage<LeftSearchableTableDto> {
