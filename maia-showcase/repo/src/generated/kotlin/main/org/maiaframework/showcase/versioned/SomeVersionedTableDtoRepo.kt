...
@Repository
class SomeVersionedTableDtoRepo(
    private val dao: SomeVersionedTableDtoDao
) {


    fun getRows(searchModel: AgGridSearchModel): SearchResultPage<SomeVersionedTableDto> {
