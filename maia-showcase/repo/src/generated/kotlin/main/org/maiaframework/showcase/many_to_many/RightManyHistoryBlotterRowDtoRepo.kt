...
@Repository
class RightManyHistoryBlotterRowDtoRepo(
    private val dao: RightManyHistoryBlotterRowDtoDao
) {


    fun getRows(entityId: DomainId, searchModel: AgGridSearchModel): SearchResultPage<RightManyHistoryBlotterRowDto> {
