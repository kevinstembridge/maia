...
@Repository
class LeftManySearchableDtoRepo(
    private val dao: LeftManySearchableDtoDao
) {


    fun getRows(searchModel: AgGridSearchModel): SearchResultPage<LeftManySearchableDto> {
