...
@Repository
class LeftToRightSimpleDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = LeftToRightSimpleDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        LeftToRightSimpleDtoMeta::fieldNameToColumnName,
        LeftToRightSimpleDtoMeta::fieldNameToJdbcType
    )
