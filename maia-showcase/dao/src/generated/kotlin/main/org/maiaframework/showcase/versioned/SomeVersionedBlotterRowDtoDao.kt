...
@Repository
class SomeVersionedBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = SomeVersionedBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        SomeVersionedBlotterRowDtoMeta::fieldNameToColumnName,
        SomeVersionedBlotterRowDtoMeta::fieldNameToJdbcType
    )
