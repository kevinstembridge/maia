...
class BravoAgGridDao(
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from maia.bravo_ag_grid where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findAllBy(filter: BravoAgGridEntityFilter): List<BravoAgGridEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.bravo_ag_grid where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: BravoAgGridEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.bravo_ag_grid where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.bravo_ag_grid;",
            SqlParams(),
            { rsa -> rsa.readDomainId("id") }
        )
    ...
    fun findAllBy(filter: BravoAgGridEntityFilter, pageable: Pageable): List<BravoAgGridEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.bravo_ag_grid where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findAllAsSequence(): Sequence<BravoAgGridEntity> {
        ...
        return this.jdbcOps.queryForSequence(
            "select * from maia.bravo_ag_grid;",
            SqlParams(),
            this.entityRowMapper,
        )
    ...
    fun deleteAll() {
        this.jdbcOps.update("delete from maia.bravo_ag_grid")
    }
