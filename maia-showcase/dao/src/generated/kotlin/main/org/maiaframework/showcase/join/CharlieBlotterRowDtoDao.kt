...
@Repository
class CharlieBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = CharlieBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        CharlieBlotterRowDtoMeta::fieldNameToColumnName,
        CharlieBlotterRowDtoMeta::fieldNameToJdbcType
    )
