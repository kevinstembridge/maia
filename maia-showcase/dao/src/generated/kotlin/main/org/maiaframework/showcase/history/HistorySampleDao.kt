...
class HistorySampleDao(
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from maia.history_sample where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findOneOrNullBySomeString(someString: String): HistorySampleEntity? {
        ...
        return jdbcOps.queryForList(
            """
            select * from maia.history_sample
    ...
    fun findOneBySomeString(someString: String): HistorySampleEntity {
        ...
        return findOneOrNullBySomeString(someString)
            ?: throw EntityNotFoundException("No record with column [some_string = $someString] found in table maia.history_sample.", HistorySampleEntityMeta.TABLE_NAME)
    ...
    fun findAllBy(filter: HistorySampleEntityFilter): List<HistorySampleEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.history_sample where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: HistorySampleEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.history_sample where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.history_sample;",
            SqlParams(),
            { rsa -> rsa.readDomainId("id") }
        )
    ...
    fun findAllBy(filter: HistorySampleEntityFilter, pageable: Pageable): List<HistorySampleEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.history_sample where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun setFields(updater: HistorySampleEntityUpdater): Int {
        ...
        sql.append("update maia.history_sample set ")
