...
@Repository
class LeftSearchableBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = LeftSearchableBlotterRowDtoRowMapper(this.jdbcOps)


    private val searchModelConverter = AgGridSearchModelConverter(
        LeftSearchableBlotterRowDtoMeta::fieldNameToColumnName,
        LeftSearchableBlotterRowDtoMeta::fieldNameToJdbcType
    )


    fun search(searchModel: AgGridSearchModel): SearchResultPage<LeftSearchableBlotterRowDto> {
