...
@Repository
class LeftDetailTableDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = LeftDetailTableDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
            LeftDetailTableDtoMeta::fieldNameToColumnName,
            LeftDetailTableDtoMeta::fieldNameToJdbcType
    )        
