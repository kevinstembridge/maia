...
class BravoWithHistoryDao(
    ...
    private val entityRowMapper = BravoWithHistoryEntityRowMapper()


    private val primaryKeyRowMapper = MaiaRowMapper { rsa -> rsa.readDomainId("id") }


    private val fetchForEditDtoRowMapper = BravoWithHistoryFetchForEditDtoRowMapper()
    ...
    fun insert(entity: BravoWithHistoryEntity) {
        ...
        jdbcOps.update(
            """
            insert into maia.bravo_with_history (
                alpha_id,
                created_timestamp,
                id,
                some_int,
    ...
    private fun insertHistory(entity: BravoWithHistoryEntity, changeType: ChangeType) {
    ...
    fun count(): Long {
        ...
        return jdbcOps.queryForLong(
            "select count(*) from maia.bravo_with_history",
            SqlParams()
        )
    ...
    fun count(filter: BravoWithHistoryEntityFilter): Long {
    ...
    fun findByPrimaryKey(id: DomainId): BravoWithHistoryEntity {
        ...
        return findByPrimaryKeyOrNull(id)
            ?: throw EntityNotFoundException(
                EntityClassAndPk(
                    BravoWithHistoryEntity::class.java,
                    mapOf(
                        "id" to id,
                    )
                ),
                BravoWithHistoryEntityMeta.TABLE_NAME
            )
    ...
    fun findByPrimaryKeyOrNull(id: DomainId): BravoWithHistoryEntity? {
        ...
        return jdbcOps.queryForList(
            "select * from maia.bravo_with_history where id = :id",
            SqlParams().apply {
                addValue("id", id)
            },
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from maia.bravo_with_history where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findAllBy(filter: BravoWithHistoryEntityFilter): List<BravoWithHistoryEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.bravo_with_history where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: BravoWithHistoryEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.bravo_with_history where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.bravo_with_history;",
            SqlParams(),
            { rsa -> rsa.readDomainId("id") }
        )
    ...
    fun findAllBy(filter: BravoWithHistoryEntityFilter, pageable: Pageable): List<BravoWithHistoryEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.bravo_with_history where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findAllAsSequence(): Sequence<BravoWithHistoryEntity> {
        ...
        return this.jdbcOps.queryForSequence(
            "select * from maia.bravo_with_history;",
            SqlParams(),
            this.entityRowMapper,
        )
    ...
    fun fetchForEdit(id: DomainId): BravoWithHistoryFetchForEditDto {
        ...
        return this.jdbcOps.queryForList(
            """
            select
                maia.alpha_with_history.id as alphaId,
                maia.alpha_with_history.some_string as alphaName,
                maia.bravo_with_history.created_timestamp as createdTimestamp,
                maia.bravo_with_history.id as id,
                maia.bravo_with_history.some_int as someInt,
                maia.bravo_with_history.some_string as someString,
                maia.bravo_with_history.version as version
            from maia.bravo_with_history
            join maia.alpha_with_history
                on maia.alpha_with_history.id = maia.bravo_with_history.alpha_id
            where maia.bravo_with_history.id = :id
            """,
            SqlParams().apply {
                addValue("id", id)
            },
            ...
            ?: throw EntityNotFoundException(EntityClassAndPk(BravoWithHistoryEntity::class.java, mapOf("id" to id)), BravoWithHistoryEntityMeta.TABLE_NAME)
    ...
    fun setFields(updater: BravoWithHistoryEntityUpdater): Int {
        ...
        if (updateCount == 0) {
            ...
            throw OptimisticLockingException(BravoWithHistoryEntityMeta.TABLE_NAME, updater.primaryKeyMap, updater.version)
    ...
    fun deleteByPrimaryKey(id: DomainId): Boolean {
        ...
        val deletedCount = this.jdbcOps.update(
            "delete from maia.bravo_with_history where id = :id",
            SqlParams().apply {
                addValue("id", id)
            }
        )
    ...
    fun deleteAll() {
        this.jdbcOps.update("delete from maia.bravo_with_history")
    }
