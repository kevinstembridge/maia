...
@Repository
class LeftManyDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = LeftManyDtoRowMapper(this.jdbcOps)


    private val searchModelConverter = AgGridSearchModelConverter(
        LeftManyDtoMeta::fieldNameToColumnName,
        LeftManyDtoMeta::fieldNameToJdbcType
    )
