...
class WithOptionalIndexFieldDao(
    ...
    fun count(): Long {
        ...
        return jdbcOps.queryForLong(
            "select count(*) from maia.with_optional_index_field",
            SqlParams()
        )
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from maia.with_optional_index_field where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findBySomeOptionalString1(someOptionalString1: SomeStringType): List<WithOptionalIndexFieldEntity> {
        ...
        return jdbcOps.queryForList(
            """
            select * from maia.with_optional_index_field
    ...
    fun findAllBy(filter: WithOptionalIndexFieldEntityFilter): List<WithOptionalIndexFieldEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.with_optional_index_field where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: WithOptionalIndexFieldEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.with_optional_index_field where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.with_optional_index_field;",
            SqlParams(),
            { rsa -> rsa.readDomainId("id") }
        )
    ...
    fun findAllBy(filter: WithOptionalIndexFieldEntityFilter, pageable: Pageable): List<WithOptionalIndexFieldEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.with_optional_index_field where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
