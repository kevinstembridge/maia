...
class ForeignKeyParentDao(
    ...
    fun insert(entity: ForeignKeyParentEntity) {
        ...
        jdbcOps.update(
            """
            insert into maia.foreign_key_parent (
    ...
    fun count(): Long {
        ...
        return jdbcOps.queryForLong(
            "select count(*) from maia.foreign_key_parent",
            SqlParams()
        )
    ...
    fun findByPrimaryKeyOrNull(id: DomainId): ForeignKeyParentEntity? {
        ...
        return jdbcOps.queryForList(
            "select * from maia.foreign_key_parent where id = :id",
            SqlParams().apply {
                addValue("id", id)
            },
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from maia.foreign_key_parent where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findAllBy(filter: ForeignKeyParentEntityFilter): List<ForeignKeyParentEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.foreign_key_parent where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: ForeignKeyParentEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.foreign_key_parent where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.foreign_key_parent;",
            SqlParams(),
            { rsa -> rsa.readDomainId("id") }
        )
    ...
    fun findAllBy(filter: ForeignKeyParentEntityFilter, pageable: Pageable): List<ForeignKeyParentEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.foreign_key_parent where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findAllAsSequence(): Sequence<ForeignKeyParentEntity> {
        ...
        return this.jdbcOps.queryForSequence(
            "select * from maia.foreign_key_parent;",
            SqlParams(),
            this.entityRowMapper,
        )
