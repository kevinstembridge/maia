...
class BravoWithHistoryDtoDao(
    ...
    private val searchModelConverter = MaiaSearchModelConverter(
            BravoWithHistoryDtoMeta::fieldNameToColumnName
    )        
    ...
    fun search(searchModel: SearchModel): SearchResultPage<BravoWithHistoryDto> {
        ...
        val sqlForPage = """
            select
                ...
                maia.alpha_with_history.some_int as dtoIntFromAlpha,
                maia.bravo_with_history.some_int as dtoIntFromBravo,
                maia.alpha_with_history.some_string as dtoStringFromAlpha,
                maia.bravo_with_history.some_string as dtoStringFromBravo,
