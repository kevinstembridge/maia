...
@Repository
class PersonHistoryBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = PersonHistoryBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        PersonHistoryBlotterRowDtoMeta::fieldNameToColumnName,
        PersonHistoryBlotterRowDtoMeta::fieldNameToJdbcType
    )
