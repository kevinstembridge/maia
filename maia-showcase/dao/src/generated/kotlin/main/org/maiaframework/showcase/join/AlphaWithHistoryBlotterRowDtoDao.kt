...
@Repository
class AlphaWithHistoryBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = AlphaWithHistoryBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        AlphaWithHistoryBlotterRowDtoMeta::fieldNameToColumnName,
        AlphaWithHistoryBlotterRowDtoMeta::fieldNameToJdbcType
    )
