...
@Repository
class LeftToRightSimpleBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = LeftToRightSimpleBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        LeftToRightSimpleBlotterRowDtoMeta::fieldNameToColumnName,
        LeftToRightSimpleBlotterRowDtoMeta::fieldNameToJdbcType
    )
    ...
    fun search(searchModel: AgGridSearchModel): SearchResultPage<LeftToRightSimpleBlotterRowDto> {
        ...
        val sqlForTotalCount = """
            ...
            inner join maia.left_many
                    on maia.left_to_right_simple.left_simple_id = maia.left_many.id
            inner join maia.right_many
                    on maia.left_to_right_simple.right_simple_id = maia.right_many.id
            $whereClause
            """.trimIndent()

        val sqlForPage = """
            select
                maia.left_to_right_simple.id as id,
