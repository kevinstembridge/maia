...
class BravoWithHistoryHistoryBlotterRowDtoDao(
    ...
    private val searchModelConverter = AgGridSearchModelConverter(
        BravoWithHistoryHistoryBlotterRowDtoMeta::fieldNameToColumnName,
        BravoWithHistoryHistoryBlotterRowDtoMeta::fieldNameToJdbcType
    )
    ...
    fun search(entityId: DomainId, searchModel: AgGridSearchModel): SearchResultPage<BravoWithHistoryHistoryBlotterRowDto> {
        ...
        val entityIdFilter = "maia.bravo_with_history_history.id = :entityId"
        ...
        val sqlForPage = """
            select
                ...
                maia.bravo_with_history_history.version as version
            from maia.bravo_with_history_history
            $whereClause
            $orderByClause
