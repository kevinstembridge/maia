...
@Repository
class HistorySampleDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = HistorySampleDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        HistorySampleDtoMeta::fieldNameToColumnName,
        HistorySampleDtoMeta::fieldNameToJdbcType
    )
