    ...
    fun fetchForEdit(id: DomainId): AllFieldTypesFetchForEditDto {
        ...
        return this.jdbcOps.queryForList(
            ...
            join maia.v_party created_by_v_party
                on created_by_v_party.id = maia.all_field_types.created_by_id
            join maia.v_party last_modified_by_v_party
                on last_modified_by_v_party.id = maia.all_field_types.last_modified_by_id
            where maia.all_field_types.id = :id
            """,
            SqlParams().apply {
                addValue("id", id)
            },
