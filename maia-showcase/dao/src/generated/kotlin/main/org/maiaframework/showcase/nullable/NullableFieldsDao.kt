...
class NullableFieldsDao(
    ...
    fun insert(entity: NullableFieldsEntity) {
        ...
        jdbcOps.update(
            """
            insert into maia.nullable_fields (
    ...
    fun count(): Long {
        ...
        return jdbcOps.queryForLong(
            "select count(*) from maia.nullable_fields",
            SqlParams()
        )
    ...
    fun findByPrimaryKeyOrNull(id: DomainId): NullableFieldsEntity? {
        ...
        return jdbcOps.queryForList(
            "select * from maia.nullable_fields where id = :id",
            SqlParams().apply {
            addValue("id", id)
            },
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from maia.nullable_fields where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findOneOrNullBySomeString(someString: String): NullableFieldsEntity? {
        ...
        return jdbcOps.queryForList(
            """
            select * from maia.nullable_fields
    ...
    fun findOneBySomeString(someString: String): NullableFieldsEntity {
        ...
        return findOneOrNullBySomeString(someString)
            ?: throw EntityNotFoundException("No record with column [some_string = $someString] found in table maia.nullable_fields.", NullableFieldsEntityMeta.TABLE_NAME)
    ...
    fun findAllBy(filter: NullableFieldsEntityFilter): List<NullableFieldsEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.nullable_fields where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: NullableFieldsEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.nullable_fields where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.nullable_fields;",
            SqlParams(),
            { rsa -> rsa.readDomainId("id") }
        )
    ...
    fun findAllBy(filter: NullableFieldsEntityFilter, pageable: Pageable): List<NullableFieldsEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.nullable_fields where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun upsertBySomeString(upsertEntity: NullableFieldsEntity): DomainId {
        ...
        return jdbcOps.execute(
            ...
            from input_rows
            join maia.nullable_fields c using (some_string);
            """.trimIndent(),
            SqlParams().apply {
