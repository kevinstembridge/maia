...
class AllFieldTypesBlotterRowDtoRowMapper : MaiaRowMapper<AllFieldTypesBlotterRowDto> {


    override fun mapRow(rsa: ResultSetAdapter): AllFieldTypesBlotterRowDto {

        return AllFieldTypesBlotterRowDto(
