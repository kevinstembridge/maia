...
@Repository
class HistorySubTwoHistoryBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = HistorySubTwoHistoryBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        HistorySubTwoHistoryBlotterRowDtoMeta::fieldNameToColumnName,
        HistorySubTwoHistoryBlotterRowDtoMeta::fieldNameToJdbcType
    )
    ...
    fun search(entityId: DomainId, searchModel: AgGridSearchModel): SearchResultPage<HistorySubTwoHistoryBlotterRowDto> {
        ...
        val sqlForPage = """
            select
                ...
                maia.history_super_history.some_int as someInt,
