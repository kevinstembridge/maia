...
@Repository
class CompositePrimaryKeyBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = CompositePrimaryKeyBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        CompositePrimaryKeyBlotterRowDtoMeta::fieldNameToColumnName,
        CompositePrimaryKeyBlotterRowDtoMeta::fieldNameToJdbcType
    )
