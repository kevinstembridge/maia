...
class CompositePrimaryKeyDao(
    ...
    fun count(): Long {
        ...
        return jdbcOps.queryForLong(
            "select count(*) from maia.composite_primary_key",
            SqlParams()
        )
    ...
    fun findByPrimaryKeyOrNull(primaryKey: CompositePrimaryKeyEntityPk): CompositePrimaryKeyEntity? {
        ...
        return jdbcOps.queryForList(
            "select * from maia.composite_primary_key where some_string = :someString and some_int = :someInt",
            SqlParams().apply {
    ...
    fun findAllBy(filter: CompositePrimaryKeyEntityFilter): List<CompositePrimaryKeyEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.composite_primary_key where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: CompositePrimaryKeyEntityFilter): Sequence<CompositePrimaryKeyEntityPk> {
        ...
        return this.jdbcOps.queryForSequence(
            "select some_string, some_int from maia.composite_primary_key where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<CompositePrimaryKeyEntityPk> {
        ...
        return this.jdbcOps.queryForSequence(
            "select some_string, some_int from maia.composite_primary_key;",
            SqlParams(),
            this.primaryKeyRowMapper
        )
    ...
    fun findAllBy(filter: CompositePrimaryKeyEntityFilter, pageable: Pageable): List<CompositePrimaryKeyEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.composite_primary_key where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findAllAsSequence(): Sequence<CompositePrimaryKeyEntity> {
        ...
        return this.jdbcOps.queryForSequence(
            "select * from maia.composite_primary_key;",
            SqlParams(),
            this.entityRowMapper,
        )
    ...
    fun upsertBySomeStringAndSomeInt(upsertEntity: CompositePrimaryKeyEntity): CompositePrimaryKeyEntity {
        ...
        val persistedEntity = jdbcOps.execute(
            ...
            do update set
                ...
                version = maia.composite_primary_key.version + 1
            returning *;
            """.trimIndent(),
            SqlParams().apply {
    ...
    fun deleteAll() {
        this.jdbcOps.update("delete from maia.composite_primary_key")
    }
