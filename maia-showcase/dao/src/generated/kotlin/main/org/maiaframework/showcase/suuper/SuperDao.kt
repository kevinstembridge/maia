...
class SuperDao(
    ...
    fun findByPrimaryKeyOrNull(id: DomainId): SuperEntity? {
        ...
        return jdbcOps.queryForList(
            "select * from maia.super where id = :id",
            SqlParams().apply {
            addValue("id", id)
            },
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from maia.super where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findAllBy(filter: SuperEntityFilter): List<SuperEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.super where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: SuperEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.super where $whereClause",
            sqlParams,
    ...
    fun findAllBy(filter: SuperEntityFilter, pageable: Pageable): List<SuperEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.super where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun setFields(updater: SuperEntityUpdater): Int {
        ...
        sql.append("update maia.super set ")
    ...
    fun deleteAll() {
        this.jdbcOps.update("delete from maia.super")
    }
