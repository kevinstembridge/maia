...
@Repository
class OrganizationHistoryBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = OrganizationHistoryBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        OrganizationHistoryBlotterRowDtoMeta::fieldNameToColumnName,
        OrganizationHistoryBlotterRowDtoMeta::fieldNameToJdbcType
    )
