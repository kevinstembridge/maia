...
@Repository
class SimpleBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = SimpleBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        SimpleBlotterRowDtoMeta::fieldNameToColumnName,
        SimpleBlotterRowDtoMeta::fieldNameToJdbcType
    )
