...
class HistorySubOneDao(
    ...
    fun count(): Long {
        ...
        return jdbcOps.queryForLong(
            "select count(*) from maia.history_super",
            SqlParams()
        )
    ...
    fun findByPrimaryKey(id: DomainId): HistorySubOneEntity {
        ...
        return findByPrimaryKeyOrNull(id)
            ?: throw EntityNotFoundException(
                EntityClassAndPk(
                    HistorySubOneEntity::class.java,
                    mapOf(
                        "id" to id,
                    )
                ),
                HistorySubOneEntityMeta.TABLE_NAME
            )
    ...
    fun existsByPrimaryKey(id: DomainId): Boolean {
        ...
        val count = jdbcOps.queryForInt(
            "select count(*) from maia.history_super where id = :id",
            SqlParams().apply {
                addValue("id", id)
           }
        )
    ...
    fun findAllBy(filter: HistorySubOneEntityFilter): List<HistorySubOneEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.history_super where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: HistorySubOneEntityFilter): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.history_super where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<DomainId> {
        ...
        return this.jdbcOps.queryForSequence(
            "select id from maia.history_super;",
            SqlParams(),
            { rsa -> rsa.readDomainId("id") }
        )
    ...
    fun findAllBy(filter: HistorySubOneEntityFilter, pageable: Pageable): List<HistorySubOneEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.history_super where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findAllAsSequence(): Sequence<HistorySubOneEntity> {
        ...
        return this.jdbcOps.queryForSequence(
            "select * from maia.history_super;",
            SqlParams(),
            this.entityRowMapper,
        )
