...
@Repository
class LeftManySearchableDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = LeftManySearchableDtoRowMapper(this.jdbcOps)


    private val searchModelConverter = AgGridSearchModelConverter(
        LeftManySearchableDtoMeta::fieldNameToColumnName,
        LeftManySearchableDtoMeta::fieldNameToJdbcType
    )


    fun search(searchModel: AgGridSearchModel): SearchResultPage<LeftManySearchableDto> {
