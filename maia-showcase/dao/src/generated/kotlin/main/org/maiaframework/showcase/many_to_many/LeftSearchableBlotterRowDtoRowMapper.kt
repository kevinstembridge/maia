...
class LeftSearchableBlotterRowDtoRowMapper(
    private val jdbcOps: JdbcOps
) : MaiaRowMapper<LeftSearchableBlotterRowDto> {


    private val rightEntitiesPkAndNameDtoRowMapper = RightPkAndNameDtoRowMapper()


    override fun mapRow(rsa: ResultSetAdapter): LeftSearchableBlotterRowDto {

        val entityId = rsa.readDomainId("id")

        val rightEntitiesPkAndNameDtoList = fetchRightEntitiesPkAndNameDtos(entityId)

        return LeftSearchableBlotterRowDto(
            rsa.readDomainId("id"),
