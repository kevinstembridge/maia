...
@Repository
class BravoBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = BravoBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        BravoBlotterRowDtoMeta::fieldNameToColumnName,
        BravoBlotterRowDtoMeta::fieldNameToJdbcType
    )
