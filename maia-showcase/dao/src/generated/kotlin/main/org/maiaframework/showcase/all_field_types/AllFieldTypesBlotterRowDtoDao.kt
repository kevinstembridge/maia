...
@Repository
class AllFieldTypesBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = AllFieldTypesBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        AllFieldTypesBlotterRowDtoMeta::fieldNameToColumnName,
        AllFieldTypesBlotterRowDtoMeta::fieldNameToJdbcType
    )
