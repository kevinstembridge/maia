...
class CompositePrimaryKeyHistoryDao(
    ...
    fun count(): Long {
        ...
        return jdbcOps.queryForLong(
            "select count(*) from maia.composite_primary_key_history",
            SqlParams()
        )
    ...
    fun findByPrimaryKeyOrNull(primaryKey: CompositePrimaryKeyHistoryEntityPk): CompositePrimaryKeyHistoryEntity? {
        ...
        return jdbcOps.queryForList(
            "select * from maia.composite_primary_key_history where some_string = :someString and some_int = :someInt and version = :version",
            SqlParams().apply {
    ...
    fun findAllBy(filter: CompositePrimaryKeyHistoryEntityFilter): List<CompositePrimaryKeyHistoryEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.composite_primary_key_history where $whereClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findPrimaryKeysAsSequence(filter: CompositePrimaryKeyHistoryEntityFilter): Sequence<CompositePrimaryKeyHistoryEntityPk> {
        ...
        return this.jdbcOps.queryForSequence(
            "select some_string, some_int, version from maia.composite_primary_key_history where $whereClause",
            sqlParams,
    ...
    fun findAllPrimaryKeysAsSequence(): Sequence<CompositePrimaryKeyHistoryEntityPk> {
        ...
        return this.jdbcOps.queryForSequence(
            "select some_string, some_int, version from maia.composite_primary_key_history;",
            SqlParams(),
            this.primaryKeyRowMapper
        )
    ...
    fun findAllBy(filter: CompositePrimaryKeyHistoryEntityFilter, pageable: Pageable): List<CompositePrimaryKeyHistoryEntity> {
        ...
        return this.jdbcOps.queryForList(
            "select * from maia.composite_primary_key_history where $whereClause $orderByClause $limitClause $offsetClause",
            sqlParams,
            this.entityRowMapper
        )
    ...
    fun findAllAsSequence(): Sequence<CompositePrimaryKeyHistoryEntity> {
        ...
        return this.jdbcOps.queryForSequence(
            "select * from maia.composite_primary_key_history;",
            SqlParams(),
            this.entityRowMapper,
        )
