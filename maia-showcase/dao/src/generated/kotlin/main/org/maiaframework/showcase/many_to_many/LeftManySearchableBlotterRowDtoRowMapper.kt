...
class LeftManySearchableBlotterRowDtoRowMapper(
    private val jdbcOps: JdbcOps
) : MaiaRowMapper<LeftManySearchableBlotterRowDto> {


    private val rightEntitiesPkAndNameDtoRowMapper = RightManyPkAndNameDtoRowMapper()


    override fun mapRow(rsa: ResultSetAdapter): LeftManySearchableBlotterRowDto {

        val entityId = rsa.readDomainId("id")

        val rightEntitiesPkAndNameDtoList = fetchRightEntitiesPkAndNameDtos(entityId)

        return LeftManySearchableBlotterRowDto(
            rsa.readDomainId("id"),
