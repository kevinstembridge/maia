...
@Repository
class UserBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = UserBlotterRowDtoRowMapper()


    private val searchModelConverter = AgGridSearchModelConverter(
        UserBlotterRowDtoMeta::fieldNameToColumnName,
        UserBlotterRowDtoMeta::fieldNameToJdbcType
    )
