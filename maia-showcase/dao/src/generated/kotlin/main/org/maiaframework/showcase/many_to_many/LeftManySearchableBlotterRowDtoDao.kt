...
@Repository
class LeftManySearchableBlotterRowDtoDao(
    private val jdbcOps: JdbcOps
) {


    private val dtoRowMapper = LeftManySearchableBlotterRowDtoRowMapper(this.jdbcOps)


    private val searchModelConverter = AgGridSearchModelConverter(
        LeftManySearchableBlotterRowDtoMeta::fieldNameToColumnName,
        LeftManySearchableBlotterRowDtoMeta::fieldNameToJdbcType
    )


    fun search(searchModel: AgGridSearchModel): SearchResultPage<LeftManySearchableBlotterRowDto> {
