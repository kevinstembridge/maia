...
CREATE TABLE maia-showcase.all_field_types (
...
CREATE UNIQUE INDEX all_field_types_some_int_type_uidx ON maia-showcase.all_field_types(some_int_type);
CREATE UNIQUE INDEX all_field_types_some_long_type_uidx ON maia-showcase.all_field_types(some_long_type);
CREATE UNIQUE INDEX all_field_types_some_string_uidx ON maia-showcase.all_field_types(some_string);
CREATE UNIQUE INDEX all_field_types_some_string_nullable_uidx ON maia-showcase.all_field_types(some_string_nullable);
CREATE UNIQUE INDEX all_field_types_some_string_type_uidx ON maia-showcase.all_field_types(some_string_type);
CREATE INDEX all_field_types_some_boolean_some_string_modifiable_idx ON maia-showcase.all_field_types(some_boolean, some_string_modifiable);
