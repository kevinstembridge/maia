...
class LeftToRightUserEffectiveEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftToRightUserEffectiveEntityFilter): LeftToRightUserEffectiveEntityFilter {
    ...
    fun or(vararg filters: LeftToRightUserEffectiveEntityFilter): LeftToRightUserEffectiveEntityFilter {
    ...
    fun nor(vararg filters: LeftToRightUserEffectiveEntityFilter): LeftToRightUserEffectiveEntityFilter {
    ...
    fun isEffectiveNow(): LeftToRightUserEffectiveEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftToRightUserEffectiveEntityFilter {
        ...
        infix fun gt(value: T): LeftToRightUserEffectiveEntityFilter {
        ...
        infix fun gte(value: T): LeftToRightUserEffectiveEntityFilter {
        ...
        infix fun lt(value: T): LeftToRightUserEffectiveEntityFilter {
        ...
        infix fun lte(value: T): LeftToRightUserEffectiveEntityFilter {
        ...
        infix fun ne(value: T): LeftToRightUserEffectiveEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftToRightUserEffectiveEntityFilter {
        ...
        fun isNotNull(): LeftToRightUserEffectiveEntityFilter {
        ...
        fun isNull(): LeftToRightUserEffectiveEntityFilter {
        ...
        infix fun contains(value: T): LeftToRightUserEffectiveEntityFilter {
    ...
    class NoopFilter : LeftToRightUserEffectiveEntityFilter {


        override fun whereClause(fieldConverter: LeftToRightUserEffectiveEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class EffectiveNowFilter : LeftToRightUserEffectiveEntityFilter {
    ...
    ) : LeftToRightUserEffectiveEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftToRightUserEffectiveEntityFilter>,
