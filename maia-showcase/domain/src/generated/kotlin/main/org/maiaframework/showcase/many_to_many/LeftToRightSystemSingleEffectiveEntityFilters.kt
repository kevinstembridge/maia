...
class LeftToRightSystemSingleEffectiveEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftToRightSystemSingleEffectiveEntityFilter): LeftToRightSystemSingleEffectiveEntityFilter {
    ...
    fun or(vararg filters: LeftToRightSystemSingleEffectiveEntityFilter): LeftToRightSystemSingleEffectiveEntityFilter {
    ...
    fun nor(vararg filters: LeftToRightSystemSingleEffectiveEntityFilter): LeftToRightSystemSingleEffectiveEntityFilter {
    ...
    fun isEffectiveNow(): LeftToRightSystemSingleEffectiveEntityFilter {
    ...
    val leftSystemSingleEffective: FieldFilter<DomainId> 
        get() {

            return FieldFilter("left_system_single_effective_id", Types.OTHER, this.sqlParamCounter) { value -> value?.value }

        }


    val rightSystemSingleEffective: FieldFilter<DomainId> 
        get() {

            return FieldFilter("right_system_single_effective_id", Types.OTHER, this.sqlParamCounter) { value -> value?.value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        infix fun gt(value: T): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        infix fun gte(value: T): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        infix fun lt(value: T): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        infix fun lte(value: T): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        infix fun ne(value: T): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        fun isNotNull(): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        fun isNull(): LeftToRightSystemSingleEffectiveEntityFilter {
        ...
        infix fun contains(value: T): LeftToRightSystemSingleEffectiveEntityFilter {
    ...
    class NoopFilter : LeftToRightSystemSingleEffectiveEntityFilter {


        override fun whereClause(fieldConverter: LeftToRightSystemSingleEffectiveEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class EffectiveNowFilter : LeftToRightSystemSingleEffectiveEntityFilter {
    ...
    ) : LeftToRightSystemSingleEffectiveEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftToRightSystemSingleEffectiveEntityFilter>,
