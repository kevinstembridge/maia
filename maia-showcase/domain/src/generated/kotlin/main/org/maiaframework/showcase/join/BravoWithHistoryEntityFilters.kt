...
class BravoWithHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: BravoWithHistoryEntityFilter): BravoWithHistoryEntityFilter {
    ...
    fun or(vararg filters: BravoWithHistoryEntityFilter): BravoWithHistoryEntityFilter {
    ...
    fun nor(vararg filters: BravoWithHistoryEntityFilter): BravoWithHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): BravoWithHistoryEntityFilter {
        ...
        infix fun gt(value: T): BravoWithHistoryEntityFilter {
        ...
        infix fun gte(value: T): BravoWithHistoryEntityFilter {
        ...
        infix fun lt(value: T): BravoWithHistoryEntityFilter {
        ...
        infix fun lte(value: T): BravoWithHistoryEntityFilter {
        ...
        infix fun ne(value: T): BravoWithHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): BravoWithHistoryEntityFilter {
        ...
        fun isNotNull(): BravoWithHistoryEntityFilter {
        ...
        fun isNull(): BravoWithHistoryEntityFilter {
        ...
        infix fun contains(value: T): BravoWithHistoryEntityFilter {
    ...
    class NoopFilter : BravoWithHistoryEntityFilter {


        override fun whereClause(fieldConverter: BravoWithHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<BravoWithHistoryEntityFilter>,
