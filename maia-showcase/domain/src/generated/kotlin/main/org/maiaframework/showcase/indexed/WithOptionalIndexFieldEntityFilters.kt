...
package org.maiaframework.showcase.indexed
...
class WithOptionalIndexFieldEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: WithOptionalIndexFieldEntityFilter): WithOptionalIndexFieldEntityFilter {
    ...
    fun or(vararg filters: WithOptionalIndexFieldEntityFilter): WithOptionalIndexFieldEntityFilter {
    ...
    fun nor(vararg filters: WithOptionalIndexFieldEntityFilter): WithOptionalIndexFieldEntityFilter {
    ...
    val someOptionalString1: FieldFilter<SomeStringType?> 
        get() {

            return FieldFilter("some_optional_string1", Types.VARCHAR, this.sqlParamCounter) { value -> value?.value }

        }


    val someOptionalString2: FieldFilter<SomeStringType?> 
        get() {

            return FieldFilter("some_optional_string2", Types.VARCHAR, this.sqlParamCounter) { value -> value?.value }

        }


    val someString: FieldFilter<SomeStringType> 
        get() {

            return FieldFilter("some_string", Types.VARCHAR, this.sqlParamCounter) { value -> value?.value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): WithOptionalIndexFieldEntityFilter {
        ...
        infix fun gt(value: T): WithOptionalIndexFieldEntityFilter {
        ...
        infix fun gte(value: T): WithOptionalIndexFieldEntityFilter {
        ...
        infix fun lt(value: T): WithOptionalIndexFieldEntityFilter {
        ...
        infix fun lte(value: T): WithOptionalIndexFieldEntityFilter {
        ...
        infix fun ne(value: T): WithOptionalIndexFieldEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): WithOptionalIndexFieldEntityFilter {
        ...
        fun isNotNull(): WithOptionalIndexFieldEntityFilter {
        ...
        fun isNull(): WithOptionalIndexFieldEntityFilter {
        ...
        infix fun contains(value: T): WithOptionalIndexFieldEntityFilter {
    ...
    class NoopFilter : WithOptionalIndexFieldEntityFilter {


        override fun whereClause(fieldConverter: WithOptionalIndexFieldEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : WithOptionalIndexFieldEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<WithOptionalIndexFieldEntityFilter>,
