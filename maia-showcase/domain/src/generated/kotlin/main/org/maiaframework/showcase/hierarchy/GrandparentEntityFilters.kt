...
class GrandparentEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: GrandparentEntityFilter): GrandparentEntityFilter {
    ...
    fun or(vararg filters: GrandparentEntityFilter): GrandparentEntityFilter {
    ...
    fun nor(vararg filters: GrandparentEntityFilter): GrandparentEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): GrandparentEntityFilter {
        ...
        infix fun gt(value: T): GrandparentEntityFilter {
        ...
        infix fun gte(value: T): GrandparentEntityFilter {
        ...
        infix fun lt(value: T): GrandparentEntityFilter {
        ...
        infix fun lte(value: T): GrandparentEntityFilter {
        ...
        infix fun ne(value: T): GrandparentEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): GrandparentEntityFilter {
        ...
        fun isNotNull(): GrandparentEntityFilter {
        ...
        fun isNull(): GrandparentEntityFilter {
        ...
        infix fun contains(value: T): GrandparentEntityFilter {
    ...
    class NoopFilter : GrandparentEntityFilter {


        override fun whereClause(fieldConverter: GrandparentEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<GrandparentEntityFilter>,
