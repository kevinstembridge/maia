...
class LeftToRightManyToManyJoinEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftToRightManyToManyJoinEntityFilter): LeftToRightManyToManyJoinEntityFilter {
    ...
    fun or(vararg filters: LeftToRightManyToManyJoinEntityFilter): LeftToRightManyToManyJoinEntityFilter {
    ...
    fun nor(vararg filters: LeftToRightManyToManyJoinEntityFilter): LeftToRightManyToManyJoinEntityFilter {
    ...
    fun isEffectiveNow(): LeftToRightManyToManyJoinEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftToRightManyToManyJoinEntityFilter {
        ...
        infix fun gt(value: T): LeftToRightManyToManyJoinEntityFilter {
        ...
        infix fun gte(value: T): LeftToRightManyToManyJoinEntityFilter {
        ...
        infix fun lt(value: T): LeftToRightManyToManyJoinEntityFilter {
        ...
        infix fun lte(value: T): LeftToRightManyToManyJoinEntityFilter {
        ...
        infix fun ne(value: T): LeftToRightManyToManyJoinEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftToRightManyToManyJoinEntityFilter {
        ...
        fun isNotNull(): LeftToRightManyToManyJoinEntityFilter {
        ...
        fun isNull(): LeftToRightManyToManyJoinEntityFilter {
        ...
        infix fun contains(value: T): LeftToRightManyToManyJoinEntityFilter {
    ...
    class NoopFilter : LeftToRightManyToManyJoinEntityFilter {


        override fun whereClause(fieldConverter: LeftToRightManyToManyJoinEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class EffectiveNowFilter : LeftToRightManyToManyJoinEntityFilter {
    ...
    ) : LeftToRightManyToManyJoinEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftToRightManyToManyJoinEntityFilter>,
