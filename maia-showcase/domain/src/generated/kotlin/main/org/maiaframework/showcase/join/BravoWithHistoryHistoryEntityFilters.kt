...
class BravoWithHistoryHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: BravoWithHistoryHistoryEntityFilter): BravoWithHistoryHistoryEntityFilter {
    ...
    fun or(vararg filters: BravoWithHistoryHistoryEntityFilter): BravoWithHistoryHistoryEntityFilter {
    ...
    fun nor(vararg filters: BravoWithHistoryHistoryEntityFilter): BravoWithHistoryHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): BravoWithHistoryHistoryEntityFilter {
        ...
        infix fun gt(value: T): BravoWithHistoryHistoryEntityFilter {
        ...
        infix fun gte(value: T): BravoWithHistoryHistoryEntityFilter {
        ...
        infix fun lt(value: T): BravoWithHistoryHistoryEntityFilter {
        ...
        infix fun lte(value: T): BravoWithHistoryHistoryEntityFilter {
        ...
        infix fun ne(value: T): BravoWithHistoryHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): BravoWithHistoryHistoryEntityFilter {
        ...
        fun isNotNull(): BravoWithHistoryHistoryEntityFilter {
        ...
        fun isNull(): BravoWithHistoryHistoryEntityFilter {
        ...
        infix fun contains(value: T): BravoWithHistoryHistoryEntityFilter {
    ...
    class NoopFilter : BravoWithHistoryHistoryEntityFilter {


        override fun whereClause(fieldConverter: BravoWithHistoryHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : BravoWithHistoryHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<BravoWithHistoryHistoryEntityFilter>,
