...
class LeftToRightComplexEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftToRightComplexEntityFilter): LeftToRightComplexEntityFilter {
    ...
    fun or(vararg filters: LeftToRightComplexEntityFilter): LeftToRightComplexEntityFilter {
    ...
    fun nor(vararg filters: LeftToRightComplexEntityFilter): LeftToRightComplexEntityFilter {
    ...
    fun isEffectiveNow(): LeftToRightComplexEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftToRightComplexEntityFilter {
        ...
        infix fun gt(value: T): LeftToRightComplexEntityFilter {
        ...
        infix fun gte(value: T): LeftToRightComplexEntityFilter {
        ...
        infix fun lt(value: T): LeftToRightComplexEntityFilter {
        ...
        infix fun lte(value: T): LeftToRightComplexEntityFilter {
        ...
        infix fun ne(value: T): LeftToRightComplexEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftToRightComplexEntityFilter {
        ...
        fun isNotNull(): LeftToRightComplexEntityFilter {
        ...
        fun isNull(): LeftToRightComplexEntityFilter {
        ...
        infix fun contains(value: T): LeftToRightComplexEntityFilter {
    ...
    class NoopFilter : LeftToRightComplexEntityFilter {


        override fun whereClause(fieldConverter: LeftToRightComplexEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class EffectiveNowFilter : LeftToRightComplexEntityFilter {
    ...
    ) : LeftToRightComplexEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftToRightComplexEntityFilter>,
