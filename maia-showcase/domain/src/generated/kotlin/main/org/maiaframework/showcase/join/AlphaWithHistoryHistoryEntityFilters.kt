...
class AlphaWithHistoryHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: AlphaWithHistoryHistoryEntityFilter): AlphaWithHistoryHistoryEntityFilter {
    ...
    fun or(vararg filters: AlphaWithHistoryHistoryEntityFilter): AlphaWithHistoryHistoryEntityFilter {
    ...
    fun nor(vararg filters: AlphaWithHistoryHistoryEntityFilter): AlphaWithHistoryHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): AlphaWithHistoryHistoryEntityFilter {
        ...
        infix fun gt(value: T): AlphaWithHistoryHistoryEntityFilter {
        ...
        infix fun gte(value: T): AlphaWithHistoryHistoryEntityFilter {
        ...
        infix fun lt(value: T): AlphaWithHistoryHistoryEntityFilter {
        ...
        infix fun lte(value: T): AlphaWithHistoryHistoryEntityFilter {
        ...
        infix fun ne(value: T): AlphaWithHistoryHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): AlphaWithHistoryHistoryEntityFilter {
        ...
        fun isNotNull(): AlphaWithHistoryHistoryEntityFilter {
        ...
        fun isNull(): AlphaWithHistoryHistoryEntityFilter {
        ...
        infix fun contains(value: T): AlphaWithHistoryHistoryEntityFilter {
    ...
    class NoopFilter : AlphaWithHistoryHistoryEntityFilter {


        override fun whereClause(fieldConverter: AlphaWithHistoryHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : AlphaWithHistoryHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<AlphaWithHistoryHistoryEntityFilter>,
