...
class ChildOneEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: ChildOneEntityFilter): ChildOneEntityFilter {
    ...
    fun or(vararg filters: ChildOneEntityFilter): ChildOneEntityFilter {
    ...
    fun nor(vararg filters: ChildOneEntityFilter): ChildOneEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): ChildOneEntityFilter {
        ...
        infix fun gt(value: T): ChildOneEntityFilter {
        ...
        infix fun gte(value: T): ChildOneEntityFilter {
        ...
        infix fun lt(value: T): ChildOneEntityFilter {
        ...
        infix fun lte(value: T): ChildOneEntityFilter {
        ...
        infix fun ne(value: T): ChildOneEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): ChildOneEntityFilter {
        ...
        fun isNotNull(): ChildOneEntityFilter {
        ...
        fun isNull(): ChildOneEntityFilter {
        ...
        infix fun contains(value: T): ChildOneEntityFilter {
    ...
    class NoopFilter : ChildOneEntityFilter {


        override fun whereClause(fieldConverter: ChildOneEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<ChildOneEntityFilter>,
