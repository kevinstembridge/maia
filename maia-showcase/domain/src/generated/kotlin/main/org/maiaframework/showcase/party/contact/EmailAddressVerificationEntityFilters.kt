...
class EmailAddressVerificationEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: EmailAddressVerificationEntityFilter): EmailAddressVerificationEntityFilter {
    ...
    fun or(vararg filters: EmailAddressVerificationEntityFilter): EmailAddressVerificationEntityFilter {
    ...
    fun nor(vararg filters: EmailAddressVerificationEntityFilter): EmailAddressVerificationEntityFilter {
    ...
    val ipAddress: FieldFilter<IpAddress?> 
        get() {

            return FieldFilter("ip_address", Types.VARCHAR, this.sqlParamCounter) { value -> value?.value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): EmailAddressVerificationEntityFilter {
        ...
        infix fun gt(value: T): EmailAddressVerificationEntityFilter {
        ...
        infix fun gte(value: T): EmailAddressVerificationEntityFilter {
        ...
        infix fun lt(value: T): EmailAddressVerificationEntityFilter {
        ...
        infix fun lte(value: T): EmailAddressVerificationEntityFilter {
        ...
        infix fun ne(value: T): EmailAddressVerificationEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): EmailAddressVerificationEntityFilter {
        ...
        fun isNotNull(): EmailAddressVerificationEntityFilter {
        ...
        fun isNull(): EmailAddressVerificationEntityFilter {
        ...
        infix fun contains(value: T): EmailAddressVerificationEntityFilter {
    ...
    class NoopFilter : EmailAddressVerificationEntityFilter {
    ...
    ) : EmailAddressVerificationEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<EmailAddressVerificationEntityFilter>,
