...
class ForeignKeyParentEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: ForeignKeyParentEntityFilter): ForeignKeyParentEntityFilter {
    ...
    fun or(vararg filters: ForeignKeyParentEntityFilter): ForeignKeyParentEntityFilter {
    ...
    fun nor(vararg filters: ForeignKeyParentEntityFilter): ForeignKeyParentEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): ForeignKeyParentEntityFilter {
        ...
        infix fun gt(value: T): ForeignKeyParentEntityFilter {
        ...
        infix fun gte(value: T): ForeignKeyParentEntityFilter {
        ...
        infix fun lt(value: T): ForeignKeyParentEntityFilter {
        ...
        infix fun lte(value: T): ForeignKeyParentEntityFilter {
        ...
        infix fun ne(value: T): ForeignKeyParentEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): ForeignKeyParentEntityFilter {
        ...
        fun isNotNull(): ForeignKeyParentEntityFilter {
        ...
        fun isNull(): ForeignKeyParentEntityFilter {
        ...
        infix fun contains(value: T): ForeignKeyParentEntityFilter {
    ...
    class NoopFilter : ForeignKeyParentEntityFilter {


        override fun whereClause(fieldConverter: ForeignKeyParentEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<ForeignKeyParentEntityFilter>,
