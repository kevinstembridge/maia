...
class LeftToRightUserEffectiveRangeEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftToRightUserEffectiveRangeEntityFilter): LeftToRightUserEffectiveRangeEntityFilter {
    ...
    fun or(vararg filters: LeftToRightUserEffectiveRangeEntityFilter): LeftToRightUserEffectiveRangeEntityFilter {
    ...
    fun nor(vararg filters: LeftToRightUserEffectiveRangeEntityFilter): LeftToRightUserEffectiveRangeEntityFilter {
    ...
    fun isEffectiveNow(): LeftToRightUserEffectiveRangeEntityFilter {
    ...
    val leftUserEffective: FieldFilter<DomainId> 
        get() {

            return FieldFilter("left_user_effective_id", Types.OTHER, this.sqlParamCounter) { value -> value?.value }

        }


    val rightUserEffective: FieldFilter<DomainId> 
        get() {

            return FieldFilter("right_user_effective_id", Types.OTHER, this.sqlParamCounter) { value -> value?.value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        infix fun gt(value: T): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        infix fun gte(value: T): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        infix fun lt(value: T): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        infix fun lte(value: T): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        infix fun ne(value: T): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        fun isNotNull(): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        fun isNull(): LeftToRightUserEffectiveRangeEntityFilter {
        ...
        infix fun contains(value: T): LeftToRightUserEffectiveRangeEntityFilter {
    ...
    class NoopFilter : LeftToRightUserEffectiveRangeEntityFilter {


        override fun whereClause(fieldConverter: LeftToRightUserEffectiveRangeEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class EffectiveNowFilter : LeftToRightUserEffectiveRangeEntityFilter {
    ...
    ) : LeftToRightUserEffectiveRangeEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftToRightUserEffectiveRangeEntityFilter>,
