...
object BravoWithHistoryDtoMeta {
    ...
    fun fieldNameToColumnName(dtoFieldName: String): String {
        ...
        return when(dtoFieldName) {
            ...
            "dtoIntFromAlpha" -> "maia.alpha_with_history.some_int"
            "dtoIntFromBravo" -> "maia.bravo_with_history.some_int"
            "dtoStringFromAlpha" -> "maia.alpha_with_history.some_string"
            "dtoStringFromBravo" -> "maia.bravo_with_history.some_string"
