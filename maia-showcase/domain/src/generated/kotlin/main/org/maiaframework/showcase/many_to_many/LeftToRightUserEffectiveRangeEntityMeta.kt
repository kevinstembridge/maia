...
object LeftToRightUserEffectiveRangeEntityMeta {
    ...
    const val leftUserEffective = "left_user_effective_id"

    const val rightUserEffective = "right_user_effective_id"

    val ENTITY_KEY = EntityKey("LeftToRightUserEffectiveRange")

    val TYPE_DISCRIMINATORS = sortedSetOf<TypeDiscriminator>()

    val SCHEMA_NAME = SchemaName("maia")

    val TABLE_NAME = TableName("left_to_right_user_effective_range")
    ...
    object IndexName {
        ...
        const val left_to_right_user_effective_range_left_user_effective_id_idx = "left_to_right_user_effective_range_left_user_effective_id_idx"

        const val left_to_right_user_effective_range_right_user_effective_id_idx = "left_to_right_user_effective_range_right_user_effective_id_idx"
    ...
    fun convertClassFieldNameToTableColumnName(classFieldName: String): String {
        ...
        return when(classFieldName) {
            ...
            "id" -> "id"
            "leftUserEffective" -> "left_user_effective_id"
            "rightUserEffective" -> "right_user_effective_id"
            else ->
