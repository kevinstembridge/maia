...
class EmailAddressEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: EmailAddressEntityFilter): EmailAddressEntityFilter {
    ...
    fun or(vararg filters: EmailAddressEntityFilter): EmailAddressEntityFilter {
    ...
    fun nor(vararg filters: EmailAddressEntityFilter): EmailAddressEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): EmailAddressEntityFilter {
        ...
        infix fun gt(value: T): EmailAddressEntityFilter {
        ...
        infix fun gte(value: T): EmailAddressEntityFilter {
        ...
        infix fun lt(value: T): EmailAddressEntityFilter {
        ...
        infix fun lte(value: T): EmailAddressEntityFilter {
        ...
        infix fun ne(value: T): EmailAddressEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): EmailAddressEntityFilter {
        ...
        fun isNotNull(): EmailAddressEntityFilter {
        ...
        fun isNull(): EmailAddressEntityFilter {
        ...
        infix fun contains(value: T): EmailAddressEntityFilter {
    ...
    class NoopFilter : EmailAddressEntityFilter {


        override fun whereClause(fieldConverter: EmailAddressEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<EmailAddressEntityFilter>,
