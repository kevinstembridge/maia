...
class UserGroupMembershipEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: UserGroupMembershipEntityFilter): UserGroupMembershipEntityFilter {
    ...
    fun or(vararg filters: UserGroupMembershipEntityFilter): UserGroupMembershipEntityFilter {
    ...
    fun nor(vararg filters: UserGroupMembershipEntityFilter): UserGroupMembershipEntityFilter {
    ...
    fun isEffectiveNow(): UserGroupMembershipEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): UserGroupMembershipEntityFilter {
        ...
        infix fun gt(value: T): UserGroupMembershipEntityFilter {
        ...
        infix fun gte(value: T): UserGroupMembershipEntityFilter {
        ...
        infix fun lt(value: T): UserGroupMembershipEntityFilter {
        ...
        infix fun lte(value: T): UserGroupMembershipEntityFilter {
        ...
        infix fun ne(value: T): UserGroupMembershipEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): UserGroupMembershipEntityFilter {
        ...
        fun isNotNull(): UserGroupMembershipEntityFilter {
        ...
        fun isNull(): UserGroupMembershipEntityFilter {
        ...
        infix fun contains(value: T): UserGroupMembershipEntityFilter {
    ...
    class NoopFilter : UserGroupMembershipEntityFilter {


        override fun whereClause(fieldConverter: UserGroupMembershipEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class EffectiveNowFilter : UserGroupMembershipEntityFilter {
    ...
    ) : UserGroupMembershipEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<UserGroupMembershipEntityFilter>,
