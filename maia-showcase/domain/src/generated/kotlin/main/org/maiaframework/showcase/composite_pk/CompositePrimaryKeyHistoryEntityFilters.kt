...
class CompositePrimaryKeyHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: CompositePrimaryKeyHistoryEntityFilter): CompositePrimaryKeyHistoryEntityFilter {
    ...
    fun or(vararg filters: CompositePrimaryKeyHistoryEntityFilter): CompositePrimaryKeyHistoryEntityFilter {
    ...
    fun nor(vararg filters: CompositePrimaryKeyHistoryEntityFilter): CompositePrimaryKeyHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): CompositePrimaryKeyHistoryEntityFilter {
        ...
        infix fun gt(value: T): CompositePrimaryKeyHistoryEntityFilter {
        ...
        infix fun gte(value: T): CompositePrimaryKeyHistoryEntityFilter {
        ...
        infix fun lt(value: T): CompositePrimaryKeyHistoryEntityFilter {
        ...
        infix fun lte(value: T): CompositePrimaryKeyHistoryEntityFilter {
        ...
        infix fun ne(value: T): CompositePrimaryKeyHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): CompositePrimaryKeyHistoryEntityFilter {
        ...
        fun isNotNull(): CompositePrimaryKeyHistoryEntityFilter {
        ...
        fun isNull(): CompositePrimaryKeyHistoryEntityFilter {
        ...
        infix fun contains(value: T): CompositePrimaryKeyHistoryEntityFilter {
    ...
    class NoopFilter : CompositePrimaryKeyHistoryEntityFilter {


        override fun whereClause(fieldConverter: CompositePrimaryKeyHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : CompositePrimaryKeyHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<CompositePrimaryKeyHistoryEntityFilter>,
