...
class EmailAddressHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: EmailAddressHistoryEntityFilter): EmailAddressHistoryEntityFilter {
    ...
    fun or(vararg filters: EmailAddressHistoryEntityFilter): EmailAddressHistoryEntityFilter {
    ...
    fun nor(vararg filters: EmailAddressHistoryEntityFilter): EmailAddressHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): EmailAddressHistoryEntityFilter {
        ...
        infix fun gt(value: T): EmailAddressHistoryEntityFilter {
        ...
        infix fun gte(value: T): EmailAddressHistoryEntityFilter {
        ...
        infix fun lt(value: T): EmailAddressHistoryEntityFilter {
        ...
        infix fun lte(value: T): EmailAddressHistoryEntityFilter {
        ...
        infix fun ne(value: T): EmailAddressHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): EmailAddressHistoryEntityFilter {
        ...
        fun isNotNull(): EmailAddressHistoryEntityFilter {
        ...
        fun isNull(): EmailAddressHistoryEntityFilter {
        ...
        infix fun contains(value: T): EmailAddressHistoryEntityFilter {
    ...
    class NoopFilter : EmailAddressHistoryEntityFilter {


        override fun whereClause(fieldConverter: EmailAddressHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : EmailAddressHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<EmailAddressHistoryEntityFilter>,
