...
object LeftToRightUserEffectiveEntityMeta {
    ...
    val ENTITY_KEY = EntityKey("LeftToRightUserEffective")

    val TYPE_DISCRIMINATORS = sortedSetOf<TypeDiscriminator>()

    val SCHEMA_NAME = SchemaName("maia")

    val TABLE_NAME = TableName("left_to_right_user_effective")
    ...
    object IndexName {
        ...
        const val left_to_right_user_effective_left_user_effective_id_idx = "left_to_right_user_effective_left_user_effective_id_idx"

        const val left_to_right_user_effective_right_user_effective_id_idx = "left_to_right_user_effective_right_user_effective_id_idx"
