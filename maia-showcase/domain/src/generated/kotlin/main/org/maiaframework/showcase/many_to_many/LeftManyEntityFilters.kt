...
class LeftManyEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftManyEntityFilter): LeftManyEntityFilter {
    ...
    fun or(vararg filters: LeftManyEntityFilter): LeftManyEntityFilter {
    ...
    fun nor(vararg filters: LeftManyEntityFilter): LeftManyEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftManyEntityFilter {
        ...
        infix fun gt(value: T): LeftManyEntityFilter {
        ...
        infix fun gte(value: T): LeftManyEntityFilter {
        ...
        infix fun lt(value: T): LeftManyEntityFilter {
        ...
        infix fun lte(value: T): LeftManyEntityFilter {
        ...
        infix fun ne(value: T): LeftManyEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftManyEntityFilter {
        ...
        fun isNotNull(): LeftManyEntityFilter {
        ...
        fun isNull(): LeftManyEntityFilter {
        ...
        infix fun contains(value: T): LeftManyEntityFilter {
    ...
    class NoopFilter : LeftManyEntityFilter {


        override fun whereClause(fieldConverter: LeftManyEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftManyEntityFilter>,
