...
class ParentTwoEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: ParentTwoEntityFilter): ParentTwoEntityFilter {
    ...
    fun or(vararg filters: ParentTwoEntityFilter): ParentTwoEntityFilter {
    ...
    fun nor(vararg filters: ParentTwoEntityFilter): ParentTwoEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): ParentTwoEntityFilter {
        ...
        infix fun gt(value: T): ParentTwoEntityFilter {
        ...
        infix fun gte(value: T): ParentTwoEntityFilter {
        ...
        infix fun lt(value: T): ParentTwoEntityFilter {
        ...
        infix fun lte(value: T): ParentTwoEntityFilter {
        ...
        infix fun ne(value: T): ParentTwoEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): ParentTwoEntityFilter {
        ...
        fun isNotNull(): ParentTwoEntityFilter {
        ...
        fun isNull(): ParentTwoEntityFilter {
        ...
        infix fun contains(value: T): ParentTwoEntityFilter {
    ...
    class NoopFilter : ParentTwoEntityFilter {


        override fun whereClause(fieldConverter: ParentTwoEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<ParentTwoEntityFilter>,
