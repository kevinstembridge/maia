...
object EmailAddressHistoryEntityMeta {
    ...
    val ENTITY_KEY = EntityKey("EmailAddressHistory")

    val TYPE_DISCRIMINATORS = sortedSetOf<TypeDiscriminator>()

    val SCHEMA_NAME = SchemaName("maia")

    val TABLE_NAME = TableName("email_address_history")
    ...
    object IndexName {
        ...
        const val hist_email_address_email_address_idx = "hist_email_address_email_address_idx"
