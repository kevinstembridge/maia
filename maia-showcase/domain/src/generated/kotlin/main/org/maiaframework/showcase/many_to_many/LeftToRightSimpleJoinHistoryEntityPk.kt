...
data class LeftToRightSimpleJoinHistoryEntityPk(
    val id: DomainId,
    val version: Long
) {
    ...
    companion object {
        ...
        fun from(pk: String): LeftToRightSimpleJoinHistoryEntityPk {

            val parts = pk.split(":")
            val id = DomainId(URLDecoder.decode(parts[0], "UTF-8"))
            val version = URLDecoder.decode(parts[1], "UTF-8").toLong()

            return LeftToRightSimpleJoinHistoryEntityPk(id, version)
