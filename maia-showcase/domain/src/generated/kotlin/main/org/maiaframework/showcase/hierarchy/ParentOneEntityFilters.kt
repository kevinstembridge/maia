...
class ParentOneEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: ParentOneEntityFilter): ParentOneEntityFilter {
    ...
    fun or(vararg filters: ParentOneEntityFilter): ParentOneEntityFilter {
    ...
    fun nor(vararg filters: ParentOneEntityFilter): ParentOneEntityFilter {
    ...
    val someUniqueString: FieldFilter<String> 
        get() {

            return FieldFilter("some_unique_string", Types.VARCHAR, this.sqlParamCounter) { value -> value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): ParentOneEntityFilter {
        ...
        infix fun gt(value: T): ParentOneEntityFilter {
        ...
        infix fun gte(value: T): ParentOneEntityFilter {
        ...
        infix fun lt(value: T): ParentOneEntityFilter {
        ...
        infix fun lte(value: T): ParentOneEntityFilter {
        ...
        infix fun ne(value: T): ParentOneEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): ParentOneEntityFilter {
        ...
        fun isNotNull(): ParentOneEntityFilter {
        ...
        fun isNull(): ParentOneEntityFilter {
        ...
        infix fun contains(value: T): ParentOneEntityFilter {
    ...
    class NoopFilter : ParentOneEntityFilter {


        override fun whereClause(fieldConverter: ParentOneEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<ParentOneEntityFilter>,
