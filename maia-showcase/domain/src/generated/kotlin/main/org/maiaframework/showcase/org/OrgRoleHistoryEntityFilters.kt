...
class OrgRoleHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: OrgRoleHistoryEntityFilter): OrgRoleHistoryEntityFilter {
    ...
    fun or(vararg filters: OrgRoleHistoryEntityFilter): OrgRoleHistoryEntityFilter {
    ...
    fun nor(vararg filters: OrgRoleHistoryEntityFilter): OrgRoleHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): OrgRoleHistoryEntityFilter {
        ...
        infix fun gt(value: T): OrgRoleHistoryEntityFilter {
        ...
        infix fun gte(value: T): OrgRoleHistoryEntityFilter {
        ...
        infix fun lt(value: T): OrgRoleHistoryEntityFilter {
        ...
        infix fun lte(value: T): OrgRoleHistoryEntityFilter {
        ...
        infix fun ne(value: T): OrgRoleHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): OrgRoleHistoryEntityFilter {
        ...
        fun isNotNull(): OrgRoleHistoryEntityFilter {
        ...
        fun isNull(): OrgRoleHistoryEntityFilter {
        ...
        infix fun contains(value: T): OrgRoleHistoryEntityFilter {
    ...
    class NoopFilter : OrgRoleHistoryEntityFilter {


        override fun whereClause(fieldConverter: OrgRoleHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<OrgRoleHistoryEntityFilter>,
