...
class LeftToRightSimpleJoinHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftToRightSimpleJoinHistoryEntityFilter): LeftToRightSimpleJoinHistoryEntityFilter {
    ...
    fun or(vararg filters: LeftToRightSimpleJoinHistoryEntityFilter): LeftToRightSimpleJoinHistoryEntityFilter {
    ...
    fun nor(vararg filters: LeftToRightSimpleJoinHistoryEntityFilter): LeftToRightSimpleJoinHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        infix fun gt(value: T): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        infix fun gte(value: T): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        infix fun lt(value: T): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        infix fun lte(value: T): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        infix fun ne(value: T): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        fun isNotNull(): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        fun isNull(): LeftToRightSimpleJoinHistoryEntityFilter {
        ...
        infix fun contains(value: T): LeftToRightSimpleJoinHistoryEntityFilter {
    ...
    class NoopFilter : LeftToRightSimpleJoinHistoryEntityFilter {


        override fun whereClause(fieldConverter: LeftToRightSimpleJoinHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : LeftToRightSimpleJoinHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftToRightSimpleJoinHistoryEntityFilter>,
