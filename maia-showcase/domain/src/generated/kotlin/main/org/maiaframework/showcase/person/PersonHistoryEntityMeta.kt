...
object PersonHistoryEntityMeta {
    ...
    val ENTITY_KEY = EntityKey("PersonHistory")
    ...
    fun typeDiscriminatorFor(personHistoryEntity: PersonHistoryEntity): TypeDiscriminator {

        return when(personHistoryEntity) {
            is UserHistoryEntity -> TypeDiscriminator("USR")
            is PersonHistoryEntity -> TypeDiscriminator("PER")
            else -> throw IllegalStateException("Unknown type of PartyEntity: $personHistoryEntity")
        }
