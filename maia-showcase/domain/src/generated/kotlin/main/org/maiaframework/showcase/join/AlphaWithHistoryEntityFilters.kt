...
class AlphaWithHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: AlphaWithHistoryEntityFilter): AlphaWithHistoryEntityFilter {
    ...
    fun or(vararg filters: AlphaWithHistoryEntityFilter): AlphaWithHistoryEntityFilter {
    ...
    fun nor(vararg filters: AlphaWithHistoryEntityFilter): AlphaWithHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): AlphaWithHistoryEntityFilter {
        ...
        infix fun gt(value: T): AlphaWithHistoryEntityFilter {
        ...
        infix fun gte(value: T): AlphaWithHistoryEntityFilter {
        ...
        infix fun lt(value: T): AlphaWithHistoryEntityFilter {
        ...
        infix fun lte(value: T): AlphaWithHistoryEntityFilter {
        ...
        infix fun ne(value: T): AlphaWithHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): AlphaWithHistoryEntityFilter {
        ...
        fun isNotNull(): AlphaWithHistoryEntityFilter {
        ...
        fun isNull(): AlphaWithHistoryEntityFilter {
        ...
        infix fun contains(value: T): AlphaWithHistoryEntityFilter {
    ...
    class NoopFilter : AlphaWithHistoryEntityFilter {


        override fun whereClause(fieldConverter: AlphaWithHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<AlphaWithHistoryEntityFilter>,
