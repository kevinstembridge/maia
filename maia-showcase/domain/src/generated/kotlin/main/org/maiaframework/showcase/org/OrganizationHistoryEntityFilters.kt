...
class OrganizationHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: OrganizationHistoryEntityFilter): OrganizationHistoryEntityFilter {
    ...
    fun or(vararg filters: OrganizationHistoryEntityFilter): OrganizationHistoryEntityFilter {
    ...
    fun nor(vararg filters: OrganizationHistoryEntityFilter): OrganizationHistoryEntityFilter {
    ...
    val orgName: FieldFilter<String> 
        get() {

            return FieldFilter("org_name", Types.VARCHAR, this.sqlParamCounter) { value -> value }
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): OrganizationHistoryEntityFilter {
        ...
        infix fun gt(value: T): OrganizationHistoryEntityFilter {
        ...
        infix fun gte(value: T): OrganizationHistoryEntityFilter {
        ...
        infix fun lt(value: T): OrganizationHistoryEntityFilter {
        ...
        infix fun lte(value: T): OrganizationHistoryEntityFilter {
        ...
        infix fun ne(value: T): OrganizationHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): OrganizationHistoryEntityFilter {
        ...
        fun isNotNull(): OrganizationHistoryEntityFilter {
        ...
        fun isNull(): OrganizationHistoryEntityFilter {
        ...
        infix fun contains(value: T): OrganizationHistoryEntityFilter {
    ...
    class NoopFilter : OrganizationHistoryEntityFilter {


        override fun whereClause(fieldConverter: OrganizationHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    ) : OrganizationHistoryEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<OrganizationHistoryEntityFilter>,
