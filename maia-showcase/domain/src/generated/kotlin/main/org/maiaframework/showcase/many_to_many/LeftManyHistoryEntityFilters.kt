...
class LeftManyHistoryEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: LeftManyHistoryEntityFilter): LeftManyHistoryEntityFilter {
    ...
    fun or(vararg filters: LeftManyHistoryEntityFilter): LeftManyHistoryEntityFilter {
    ...
    fun nor(vararg filters: LeftManyHistoryEntityFilter): LeftManyHistoryEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): LeftManyHistoryEntityFilter {
        ...
        infix fun gt(value: T): LeftManyHistoryEntityFilter {
        ...
        infix fun gte(value: T): LeftManyHistoryEntityFilter {
        ...
        infix fun lt(value: T): LeftManyHistoryEntityFilter {
        ...
        infix fun lte(value: T): LeftManyHistoryEntityFilter {
        ...
        infix fun ne(value: T): LeftManyHistoryEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): LeftManyHistoryEntityFilter {
        ...
        fun isNotNull(): LeftManyHistoryEntityFilter {
        ...
        fun isNull(): LeftManyHistoryEntityFilter {
        ...
        infix fun contains(value: T): LeftManyHistoryEntityFilter {
    ...
    class NoopFilter : LeftManyHistoryEntityFilter {


        override fun whereClause(fieldConverter: LeftManyHistoryEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class IterableFunctionFilter(
        private val filters: List<LeftManyHistoryEntityFilter>,
