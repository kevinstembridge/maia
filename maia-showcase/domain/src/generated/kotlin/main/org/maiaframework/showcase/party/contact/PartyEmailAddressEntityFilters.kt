...
class PartyEmailAddressEntityFilters {


    private val sqlParamCounter = AtomicInteger(1)


    fun and(vararg filters: PartyEmailAddressEntityFilter): PartyEmailAddressEntityFilter {
    ...
    fun or(vararg filters: PartyEmailAddressEntityFilter): PartyEmailAddressEntityFilter {
    ...
    fun nor(vararg filters: PartyEmailAddressEntityFilter): PartyEmailAddressEntityFilter {
    ...
    fun isEffectiveNow(): PartyEmailAddressEntityFilter {
    ...
    class FieldFilter<T>(
        ...
        infix fun eq(value: T): PartyEmailAddressEntityFilter {
        ...
        infix fun gt(value: T): PartyEmailAddressEntityFilter {
        ...
        infix fun gte(value: T): PartyEmailAddressEntityFilter {
        ...
        infix fun lt(value: T): PartyEmailAddressEntityFilter {
        ...
        infix fun lte(value: T): PartyEmailAddressEntityFilter {
        ...
        infix fun ne(value: T): PartyEmailAddressEntityFilter {
        ...
        infix fun `in`(value: Iterable<T>): PartyEmailAddressEntityFilter {
        ...
        fun isNotNull(): PartyEmailAddressEntityFilter {
        ...
        fun isNull(): PartyEmailAddressEntityFilter {
        ...
        infix fun contains(value: T): PartyEmailAddressEntityFilter {
    ...
    class NoopFilter : PartyEmailAddressEntityFilter {


        override fun whereClause(fieldConverter: PartyEmailAddressEntityFieldConverter): String {
            return "1 = 1"
        }
    ...
    private class EffectiveNowFilter : PartyEmailAddressEntityFilter {
    ...
    private class IterableFunctionFilter(
        private val filters: List<PartyEmailAddressEntityFilter>,
