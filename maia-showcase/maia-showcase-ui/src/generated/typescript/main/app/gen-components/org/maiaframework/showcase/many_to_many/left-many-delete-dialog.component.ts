...
@Component({
    ...
    templateUrl: './left-many-delete-dialog.component.html'
})
export class LeftManyDeleteDialogComponent {
    ...
    private readonly dialogRef = inject(MatDialogRef<LeftManyDeleteDialogComponent>);
