...
import {OrganizationHistoryBlotterAgGridDatasource} from '@app/gen-components/org/maiaframework/showcase/org/OrganizationHistoryBlotterAgGridDatasource';
...
@Component({
    ...
    providers: [OrganizationHistoryBlotterAgGridDatasource],
    selector: 'app-organization-history-blotter',
    templateUrl: './organization-history-blotter.html'
})
export class OrganizationHistoryBlotter implements OnInit {
    ...
    public rowData!: OrganizationHistoryBlotterRowDto[];


    private gridApi!: GridApi<OrganizationHistoryBlotterRowDto>;


    private readonly datasource = inject(OrganizationHistoryBlotterAgGridDatasource);
    ...
    onGridReady(params: GridReadyEvent<OrganizationHistoryBlotterRowDto>): void {
