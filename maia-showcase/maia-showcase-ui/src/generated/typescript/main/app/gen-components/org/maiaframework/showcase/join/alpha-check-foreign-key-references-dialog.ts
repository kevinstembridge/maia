...
@Component({
    ...
    selector: 'app-alpha-check-foreign-key-references-dialog',
    templateUrl: './alpha-check-foreign-key-references-dialog.html'
})
export class AlphaCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<AlphaCheckForeignKeyReferencesDialog>);
