...
@Component({
    ...
    styleUrls: ['./bravo-create-dialog.scss'],
    templateUrl: './bravo-create-dialog.html'
})
export class BravoCreateDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<BravoCreateDialog>);
