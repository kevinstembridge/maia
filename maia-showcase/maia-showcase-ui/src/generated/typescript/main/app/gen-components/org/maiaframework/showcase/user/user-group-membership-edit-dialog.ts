...
@Component({
    ...
    styleUrls: ['./user-group-membership-edit-dialog.scss'],
    templateUrl: './user-group-membership-edit-dialog.html'
})
export class UserGroupMembershipEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<UserGroupMembershipEditDialog>);
