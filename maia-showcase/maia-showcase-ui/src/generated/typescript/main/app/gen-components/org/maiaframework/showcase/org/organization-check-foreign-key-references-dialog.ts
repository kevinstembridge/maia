...
@Component({
    ...
    selector: 'app-organization-check-foreign-key-references-dialog',
    templateUrl: './organization-check-foreign-key-references-dialog.html'
})
export class OrganizationCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<OrganizationCheckForeignKeyReferencesDialog>);
    ...
    ngOnInit() {
        ...
        this.foreignKeyReferenceService.checkOrganizationForReferences(this.dto.id)
          .pipe(
