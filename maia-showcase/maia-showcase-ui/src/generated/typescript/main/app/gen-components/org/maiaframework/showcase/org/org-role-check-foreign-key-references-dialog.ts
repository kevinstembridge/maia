...
@Component({
    ...
    selector: 'app-org-role-check-foreign-key-references-dialog',
    templateUrl: './org-role-check-foreign-key-references-dialog.html'
})
export class OrgRoleCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<OrgRoleCheckForeignKeyReferencesDialog>);
    ...
    ngOnInit() {
        ...
        this.foreignKeyReferenceService.checkOrgRoleForReferences(this.dto.id)
          .pipe(
