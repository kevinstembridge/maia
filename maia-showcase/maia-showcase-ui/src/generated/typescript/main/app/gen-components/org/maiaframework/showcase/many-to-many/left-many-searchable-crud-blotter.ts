...
import {LeftManySearchableBlotter} from '@app/gen-components/org/maiaframework/showcase/many-to-many/left-many-searchable-blotter';


@Component({
    imports: [LeftManySearchableBlotter],
    selector: 'app-left-many-searchable-crud-blotter',
    templateUrl: './left-many-searchable-crud-blotter.html'
})
