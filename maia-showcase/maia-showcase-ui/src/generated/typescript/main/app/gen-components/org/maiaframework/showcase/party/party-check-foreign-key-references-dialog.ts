...
@Component({
    ...
    templateUrl: './party-check-foreign-key-references-dialog.html'
})
export class PartyCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<PartyCheckForeignKeyReferencesDialog>);
