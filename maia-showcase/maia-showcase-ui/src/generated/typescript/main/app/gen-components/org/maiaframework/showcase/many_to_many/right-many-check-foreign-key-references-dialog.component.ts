...
@Component({
    ...
    selector: 'app-right-many-check-foreign-key-references-dialog',
    templateUrl: './right-many-check-foreign-key-references-dialog.component.html'
})
export class RightManyCheckForeignKeyReferencesDialogComponent implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<RightManyCheckForeignKeyReferencesDialogComponent>);
    ...
    ngOnInit() {
        ...
        this.foreignKeyReferenceService.checkRightManyForReferences(this.dto.id)
          .pipe(
