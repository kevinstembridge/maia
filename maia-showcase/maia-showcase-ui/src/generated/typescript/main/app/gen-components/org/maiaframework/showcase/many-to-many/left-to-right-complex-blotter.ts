...
@Component({
    ...
    providers: [LeftToRightComplexBlotterService, LeftToRightComplexBlotterAgGridDatasource, DecimalPipe],
    selector: 'app-left-to-right-complex-blotter',
    templateUrl: './left-to-right-complex-blotter.html'
})
export class LeftToRightComplexBlotter {
    ...
    public rowData!: LeftToRightComplexBlotterRowDto[];


    private gridApi!: GridApi<LeftToRightComplexBlotterRowDto>;


    private readonly datasource = inject(LeftToRightComplexBlotterAgGridDatasource);
