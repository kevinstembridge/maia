...
@Component({
    ...
    styleUrls: ['./left-many-edit-dialog.scss'],
    templateUrl: './left-many-edit-dialog.html'
})
export class LeftManyEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<LeftManyEditDialog>);
