...
@Component({
    ...
    selector: 'app-left-many-check-foreign-key-references-dialog',
    templateUrl: './left-many-check-foreign-key-references-dialog.component.html'
})
export class LeftManyCheckForeignKeyReferencesDialogComponent implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<LeftManyCheckForeignKeyReferencesDialogComponent>);
