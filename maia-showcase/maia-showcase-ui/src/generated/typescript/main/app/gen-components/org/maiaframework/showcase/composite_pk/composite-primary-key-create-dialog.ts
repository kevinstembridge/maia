...
@Component({
    ...
    styleUrls: ['./composite-primary-key-create-dialog.scss'],
    templateUrl: './composite-primary-key-create-dialog.html'
})
export class CompositePrimaryKeyCreateDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<CompositePrimaryKeyCreateDialog>);
