...
import {LeftSearchableTableComponent} from '@app/gen-components/org/maiaframework/showcase/many_to_many/left-searchable-table.component';


@Component({
    imports: [LeftSearchableTableComponent],
    selector: 'app-left-searchable-crud-table',
    templateUrl: './left-searchable-crud-table.component.html'
})
export class LeftSearchableCrudTableComponent {

    @ViewChild(LeftSearchableTableComponent) tableComponent!: LeftSearchableTableComponent;
