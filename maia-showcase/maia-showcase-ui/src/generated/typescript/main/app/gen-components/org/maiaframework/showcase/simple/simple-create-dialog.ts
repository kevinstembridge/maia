...
@Component({
    ...
    styleUrls: ['./simple-create-dialog.scss'],
    templateUrl: './simple-create-dialog.html'
})
export class SimpleCreateDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<SimpleCreateDialog>);
