...
@Component({
    ...
    styleUrls: ['./all-field-types-edit-dialog.scss'],
    templateUrl: './all-field-types-edit-dialog.html'
})
export class AllFieldTypesEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<AllFieldTypesEditDialog>);
