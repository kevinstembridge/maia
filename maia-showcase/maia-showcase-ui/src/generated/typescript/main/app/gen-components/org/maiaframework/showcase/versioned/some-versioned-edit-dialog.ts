...
@Component({
    ...
    styleUrls: ['./some-versioned-edit-dialog.scss'],
    templateUrl: './some-versioned-edit-dialog.html'
})
export class SomeVersionedEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<SomeVersionedEditDialog>);
