...
@Component({
    ...
    styleUrls: ['./composite-primary-key-edit-dialog.scss'],
    templateUrl: './composite-primary-key-edit-dialog.html'
})
export class CompositePrimaryKeyEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<CompositePrimaryKeyEditDialog>);


    private readonly formService = inject(CompositePrimaryKeyCrudService);


    private readonly entityId = inject<{someInt: number, someString: string}>(MAT_DIALOG_DATA);
