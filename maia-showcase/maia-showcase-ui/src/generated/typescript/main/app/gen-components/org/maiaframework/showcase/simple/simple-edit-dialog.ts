...
@Component({
    ...
    styleUrls: ['./simple-edit-dialog.scss'],
    templateUrl: './simple-edit-dialog.html'
})
export class SimpleEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<SimpleEditDialog>);
