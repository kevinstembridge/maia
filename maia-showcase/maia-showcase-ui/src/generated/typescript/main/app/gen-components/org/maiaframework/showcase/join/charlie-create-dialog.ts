...
@Component({
    ...
    styleUrls: ['./charlie-create-dialog.scss'],
    templateUrl: './charlie-create-dialog.html'
})
export class CharlieCreateDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<CharlieCreateDialog>);
