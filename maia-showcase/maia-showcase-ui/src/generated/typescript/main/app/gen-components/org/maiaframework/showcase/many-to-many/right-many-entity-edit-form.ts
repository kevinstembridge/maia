    ...
    ngOnInit() {
        ...
        this.formService.fetchForEdit(this.entityId()).subscribe({
            next: (dto: RightManyFetchForEditDto) => {
                ...
                this.leftSystemEffectiveJoins = dto.leftSystemEffectiveEntities?.map(e => ({
                    id: e.id,
                    entityId: e.entityId,
                    entityName: e.name,
                ...
                this.leftSystemSingleEffectiveJoins = dto.leftSystemSingleEffectiveEntities?.map(e => ({
                    id: e.id,
                    entityId: e.entityId,
                    entityName: e.name,
                    effectiveFrom: e.effectiveFrom ? new Date(e.effectiveFrom) : null,
                ...
                this.leftUserEffectiveJoins = dto.leftUserEffectiveEntities?.map(e => ({
                    id: e.id,
                    entityId: e.entityId,
                    entityName: e.name,
                    effectiveFrom: e.effectiveFrom ? new Date(e.effectiveFrom) : null,
