...
@Component({
    ...
    templateUrl: './alpha-check-foreign-key-references-dialog.component.html'
})
export class AlphaCheckForeignKeyReferencesDialogComponent implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<AlphaCheckForeignKeyReferencesDialogComponent>);
