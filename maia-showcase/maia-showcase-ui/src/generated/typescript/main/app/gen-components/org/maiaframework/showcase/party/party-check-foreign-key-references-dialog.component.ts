...
@Component({
    ...
    selector: 'app-party-check-foreign-key-references-dialog',
    templateUrl: './party-check-foreign-key-references-dialog.component.html'
})
export class PartyCheckForeignKeyReferencesDialogComponent implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<PartyCheckForeignKeyReferencesDialogComponent>);
