...
@Component({
    ...
    templateUrl: './right-many-check-foreign-key-references-dialog.html'
})
export class RightManyCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<RightManyCheckForeignKeyReferencesDialog>);
