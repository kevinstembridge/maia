...
@Component({
    ...
    styleUrls: ['./charlie-edit-dialog.scss'],
    templateUrl: './charlie-edit-dialog.html'
})
export class CharlieEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<CharlieEditDialog>);
