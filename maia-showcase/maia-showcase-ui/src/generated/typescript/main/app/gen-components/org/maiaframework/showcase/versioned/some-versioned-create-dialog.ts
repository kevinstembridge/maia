...
@Component({
    ...
    styleUrls: ['./some-versioned-create-dialog.scss'],
    templateUrl: './some-versioned-create-dialog.html'
})
export class SomeVersionedCreateDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<SomeVersionedCreateDialog>);
