...
@Component({
    ...
    styleUrls: ['./bravo-edit-dialog.scss'],
    templateUrl: './bravo-edit-dialog.html'
})
export class BravoEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<BravoEditDialog>);
