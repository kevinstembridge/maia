...
@Component({
    ...
    styleUrls: ['./charlie-ag-grid-edit-dialog.scss'],
    templateUrl: './charlie-ag-grid-edit-dialog.html'
})
export class CharlieAgGridEditDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<CharlieAgGridEditDialog>);
