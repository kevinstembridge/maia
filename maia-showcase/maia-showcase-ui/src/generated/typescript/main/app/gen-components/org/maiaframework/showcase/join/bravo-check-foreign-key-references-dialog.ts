...
@Component({
    ...
    templateUrl: './bravo-check-foreign-key-references-dialog.html'
})
export class BravoCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<BravoCheckForeignKeyReferencesDialog>);
