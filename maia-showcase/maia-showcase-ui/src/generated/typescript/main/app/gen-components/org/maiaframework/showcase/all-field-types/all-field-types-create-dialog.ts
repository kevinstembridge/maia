...
@Component({
    ...
    styleUrls: ['./all-field-types-create-dialog.scss'],
    templateUrl: './all-field-types-create-dialog.html'
})
export class AllFieldTypesCreateDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<AllFieldTypesCreateDialog>);
