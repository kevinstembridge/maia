...
import {LeftManyFetchForEditDto} from '@app/gen-components/org/maiaframework/showcase/many_to_many/LeftManyFetchForEditDto';
import {LeftManyUpdateRequestDto} from '@app/gen-components/org/maiaframework/showcase/many_to_many/LeftManyUpdateRequestDto';
...
@Component({
    ...
    selector: 'app-left-many-edit-dialog',
    styleUrls: ['./left-many-edit-dialog.component.scss'],
    templateUrl: './left-many-edit-dialog.component.html'
})
export class LeftManyEditDialogComponent implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<LeftManyEditDialogComponent>);
