...
@Component({
    ...
    templateUrl: './left-many-check-foreign-key-references-dialog.html'
})
export class LeftManyCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<LeftManyCheckForeignKeyReferencesDialog>);
