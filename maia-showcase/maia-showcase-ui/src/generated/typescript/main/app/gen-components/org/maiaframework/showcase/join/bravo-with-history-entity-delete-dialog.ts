...
@Component({
    ...
    selector: 'app-bravo-with-history-entity-delete-dialog',
    templateUrl: './bravo-with-history-entity-delete-dialog.html'
})
export class BravoWithHistoryEntityDeleteDialog {
    ...
    private readonly dialogRef = inject(MatDialogRef<BravoWithHistoryEntityDeleteDialog>);


    private readonly dto = inject<any>(MAT_DIALOG_DATA);


    private readonly crudService = inject(BravoWithHistoryCrudService);
