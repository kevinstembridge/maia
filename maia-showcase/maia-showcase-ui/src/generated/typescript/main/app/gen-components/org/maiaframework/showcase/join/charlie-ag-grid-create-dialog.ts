...
@Component({
    ...
    styleUrls: ['./charlie-ag-grid-create-dialog.scss'],
    templateUrl: './charlie-ag-grid-create-dialog.html'
})
export class CharlieAgGridCreateDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<CharlieAgGridCreateDialog>);
