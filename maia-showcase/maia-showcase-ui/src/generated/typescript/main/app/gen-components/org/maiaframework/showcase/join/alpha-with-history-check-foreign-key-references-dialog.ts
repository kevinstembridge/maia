...
@Component({
    ...
    selector: 'app-alpha-with-history-check-foreign-key-references-dialog',
    templateUrl: './alpha-with-history-check-foreign-key-references-dialog.html'
})
export class AlphaWithHistoryCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<AlphaWithHistoryCheckForeignKeyReferencesDialog>);
    ...
    ngOnInit() {
        ...
        this.foreignKeyReferenceService.checkAlphaWithHistoryForReferences(this.dto.id)
          .pipe(
