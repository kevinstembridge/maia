...
import {SomeVersionedEntityDetailView} from '@app/gen-components/org/maiaframework/showcase/versioned/some-versioned-entity-detail-view';
...
@Component({
    ...
    imports: [
        ...
        MatIconModule,
        PageLayout,
        SomeVersionedEntityDetailView
    ],
    selector: 'app-some-versioned-entity-detail-view-page',
    templateUrl: './some-versioned-entity-detail-view-page.html'
})
export class SomeVersionedEntityDetailViewPage {
    ...
    onEditClicked(): void {
        ...
        if (id) {
            this.router.navigate(['/some-versioned/edit', id]);
        }
    }
