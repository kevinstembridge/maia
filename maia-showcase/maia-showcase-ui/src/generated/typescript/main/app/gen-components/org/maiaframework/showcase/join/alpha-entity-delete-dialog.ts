...
@Component({
    ...
    selector: 'app-alpha-entity-delete-dialog',
    templateUrl: './alpha-entity-delete-dialog.html'
})
export class AlphaEntityDeleteDialog {
    ...
    private readonly dialogRef = inject(MatDialogRef<AlphaEntityDeleteDialog>);


    private readonly dto = inject<any>(MAT_DIALOG_DATA);


    private readonly crudService = inject(AlphaCrudService);
