...
@Component({
    ...
    selector: 'app-bravo-ag-grid-check-foreign-key-references-dialog',
    templateUrl: './bravo-ag-grid-check-foreign-key-references-dialog.html'
})
export class BravoAgGridCheckForeignKeyReferencesDialog implements OnInit {
    ...
    private readonly dialogRef = inject(MatDialogRef<BravoAgGridCheckForeignKeyReferencesDialog>);
