...
@Component({
    ...
    styleUrls: ['./left-many-create-dialog.scss'],
    templateUrl: './left-many-create-dialog.html'
})
export class LeftManyCreateDialog implements OnInit {
    ...
    readonly dialogRef = inject(MatDialogRef<LeftManyCreateDialog>);
