...
export class SimpleCreateDialogComponent implements OnInit {
    ...
    constructor(
        ...
        this.formGroup = new FormGroup(
            {
                someString: new FormControl('', { updateOn: 'change', validators: [Validators.required, Validators.maxLength(100)], asyncValidators: [this.simpleSomeStringAsyncValidator.validate.bind(this.simpleSomeStringAsyncValidator)] }),
            },
        );
