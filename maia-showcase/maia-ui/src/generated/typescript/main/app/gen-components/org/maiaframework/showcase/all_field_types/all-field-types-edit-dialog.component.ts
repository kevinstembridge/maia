...
export class AllFieldTypesEditDialogComponent implements OnInit {
    ...
    dialogFormModel = signal<AllFieldTypesUpdateRequestDto>({
        id: '',
        lastModifiedById: '',
    ...
    dialogForm = form(this.dialogFormModel, (schemaPath) => {
        ...
        required(schemaPath.lastModifiedByUsername, { message: 'Last Modified By is required' })
        maxLength(schemaPath.lastModifiedByUsername, 100)
        required(schemaPath.id, { message: 'ID is required' })
        required(schemaPath.createdById, { message: 'Created By is required' })
        required(schemaPath.lastModifiedById, { message: 'Last Modified By is required' })
    });
