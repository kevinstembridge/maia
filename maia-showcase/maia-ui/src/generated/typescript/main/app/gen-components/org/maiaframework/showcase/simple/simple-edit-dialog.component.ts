...
export class SimpleEditDialogComponent implements OnInit {
    ...
    constructor(
        ...
        this.formGroup = new FormGroup(
            {
                someString: new FormControl(dto.someString, { updateOn: 'change', validators: [Validators.required, Validators.maxLength(100)], asyncValidators: [this.simpleSomeStringAsyncValidator.validate.bind(this.simpleSomeStringAsyncValidator)] }),
